...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200444:	b0050513          	addi	a0,a0,-1280 # 80200f40 <etext+0x524>
    ...
    80200452:	ae250513          	addi	a0,a0,-1310 # 80200f30 <etext+0x514>
                num++;
...
void exception_handler(struct trapframe *tf) {
    ...
    802004da:	b91ff0ef          	jal	ra,8020006a <cprintf>
            tf->epc += 2;
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    802004f8:	bf85                	j	80200468 <exception_handler>
        interrupt_handler(tf);
    802004fa:	b5d1                	j	802003be <interrupt_handler>
