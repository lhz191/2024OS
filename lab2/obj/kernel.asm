...
ffffffffc020081e:	c14d                	beqz	a0,ffffffffc02008c0 <best_fit_alloc_pages+0xa2>
    if (n > nr_free) {
ffffffffc0200820:	00005697          	auipc	a3,0x5
ffffffffc0200824:	7f068693          	addi	a3,a3,2032 # ffffffffc0206010 <free_area>
ffffffffc0200828:	0106a803          	lw	a6,16(a3)
ffffffffc020082c:	85aa                	mv	a1,a0
...
list_next(list_entry_t *listelm) {
    return listelm->next;
ffffffffc0200838:	669c                	ld	a5,8(a3)
    size_t min_size = nr_free + 1;
ffffffffc020083a:	0018061b          	addiw	a2,a6,1
ffffffffc020083e:	1602                	slli	a2,a2,0x20
ffffffffc0200840:	9201                	srli	a2,a2,0x20
    struct Page *page = NULL;
ffffffffc0200842:	4501                	li	a0,0
    while ((le = list_next(le)) != &free_list) {
ffffffffc0200844:	06d78b63          	beq	a5,a3,ffffffffc02008ba <best_fit_alloc_pages+0x9c>
        if (p->property < min_size && p->property >= n) {
ffffffffc0200848:	ff87e703          	lwu	a4,-8(a5)
ffffffffc020084c:	00c77763          	bgeu	a4,a2,ffffffffc020085a <best_fit_alloc_pages+0x3c>
ffffffffc0200850:	00b76563          	bltu	a4,a1,ffffffffc020085a <best_fit_alloc_pages+0x3c>
        struct Page *p = le2page(le, page_link);
ffffffffc0200854:	fe878513          	addi	a0,a5,-24
ffffffffc0200858:	863a                	mv	a2,a4
ffffffffc020085a:	679c                	ld	a5,8(a5)
    while ((le = list_next(le)) != &free_list) {
ffffffffc020085c:	fed796e3          	bne	a5,a3,ffffffffc0200848 <best_fit_alloc_pages+0x2a>
    if (page != NULL) {
...
ffffffffc0200864:	6d18                	ld	a4,24(a0)
        if (page->property > n) {
ffffffffc0200866:	4910                	lw	a2,16(a0)
            p->property = page->property - n;
ffffffffc0200868:	0005889b          	sext.w	a7,a1
...
ffffffffc020086e:	e398                	sd	a4,0(a5)
        if (page->property > n) {
ffffffffc0200870:	02061793          	slli	a5,a2,0x20
ffffffffc0200874:	9381                	srli	a5,a5,0x20
ffffffffc0200876:	02f5f863          	bgeu	a1,a5,ffffffffc02008a6 <best_fit_alloc_pages+0x88>
            struct Page *p = page + n;
ffffffffc020087a:	00259793          	slli	a5,a1,0x2
ffffffffc020087e:	97ae                	add	a5,a5,a1
ffffffffc0200880:	078e                	slli	a5,a5,0x3
ffffffffc0200882:	97aa                	add	a5,a5,a0
            p->property = page->property - n;
ffffffffc0200884:	4116063b          	subw	a2,a2,a7
ffffffffc0200888:	cb90                	sw	a2,16(a5)
 *
...
ffffffffc020088a:	00878593          	addi	a1,a5,8
ffffffffc020088e:	4609                	li	a2,2
ffffffffc0200890:	40c5b02f          	amoor.d	zero,a2,(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc0200894:	6710                	ld	a2,8(a4)
            list_add(prev, &(p->page_link));
ffffffffc0200896:	01878593          	addi	a1,a5,24
        nr_free -= n;
ffffffffc020089a:	0106a803          	lw	a6,16(a3)
...
ffffffffc02008aa:	0106a823          	sw	a6,16(a3)
