...
ffffffffc0200842 <getdown2>:
    if(n==0)
ffffffffc0200842:	cd11                	beqz	a0,ffffffffc020085e <getdown2+0x1c>
    if(n==1)//这个是为了照顾最后n=1的情况
ffffffffc0200844:	4785                	li	a5,1
ffffffffc0200846:	00f50c63          	beq	a0,a5,ffffffffc020085e <getdown2+0x1c>
    if (n & (n - 1)) return 0;
ffffffffc020084a:	fff50793          	addi	a5,a0,-1
ffffffffc020084e:	8fe9                	and	a5,a5,a0
ffffffffc0200850:	c799                	beqz	a5,ffffffffc020085e <getdown2+0x1c>
    size_t res = 1;
ffffffffc0200852:	4785                	li	a5,1
            n = n >> 1;
ffffffffc0200854:	8105                	srli	a0,a0,0x1
            res = res << 1;
ffffffffc0200856:	0786                	slli	a5,a5,0x1
        while (n)
ffffffffc0200858:	fd75                	bnez	a0,ffffffffc0200854 <getdown2+0x12>
        return res >> 1;
ffffffffc020085a:	0017d513          	srli	a0,a5,0x1
}
ffffffffc020085e:	8082                	ret

ffffffffc0200860 <buddy_system_pmm_alloc_pages>:
static struct Page * buddy_system_pmm_alloc_pages(size_t n) {
ffffffffc0200860:	7139                	addi	sp,sp,-64
ffffffffc0200862:	fc06                	sd	ra,56(sp)
ffffffffc0200864:	f822                	sd	s0,48(sp)
ffffffffc0200866:	f426                	sd	s1,40(sp)
ffffffffc0200868:	f04a                	sd	s2,32(sp)
ffffffffc020086a:	ec4e                	sd	s3,24(sp)
ffffffffc020086c:	e852                	sd	s4,16(sp)
ffffffffc020086e:	e456                	sd	s5,8(sp)
    assert(n > 0);
ffffffffc0200870:	1e050b63          	beqz	a0,ffffffffc0200a66 <buddy_system_pmm_alloc_pages+0x206>
    if (n > buddy_zone.n_sum) {
ffffffffc0200874:	00005917          	auipc	s2,0x5
ffffffffc0200878:	79c90913          	addi	s2,s2,1948 # ffffffffc0206010 <buddy_zone>
ffffffffc020087c:	10893783          	ld	a5,264(s2)
ffffffffc0200880:	89aa                	mv	s3,a0
        return NULL;
ffffffffc0200882:	4401                	li	s0,0
    if (n > buddy_zone.n_sum) {
ffffffffc0200884:	04a7ef63          	bltu	a5,a0,ffffffffc02008e2 <buddy_system_pmm_alloc_pages+0x82>
    if(n==1)
ffffffffc0200888:	4785                	li	a5,1
ffffffffc020088a:	06f50963          	beq	a0,a5,ffffffffc02008fc <buddy_system_pmm_alloc_pages+0x9c>
    if (n & (n - 1)) return 0;
ffffffffc020088e:	fff50793          	addi	a5,a0,-1
ffffffffc0200892:	8fe9                	and	a5,a5,a0
ffffffffc0200894:	c3ad                	beqz	a5,ffffffffc02008f6 <buddy_system_pmm_alloc_pages+0x96>
ffffffffc0200896:	872a                	mv	a4,a0
    size_t res = 1;
ffffffffc0200898:	4785                	li	a5,1
            n = n >> 1;
ffffffffc020089a:	8305                	srli	a4,a4,0x1
            res = res << 1;
ffffffffc020089c:	0786                	slli	a5,a5,0x1
        while (n)
ffffffffc020089e:	ff75                	bnez	a4,ffffffffc020089a <buddy_system_pmm_alloc_pages+0x3a>
    while (n >> 1)
ffffffffc02008a0:	86be                	mv	a3,a5
ffffffffc02008a2:	8385                	srli	a5,a5,0x1
ffffffffc02008a4:	cea1                	beqz	a3,ffffffffc02008fc <buddy_system_pmm_alloc_pages+0x9c>
    size_t res = 1;
ffffffffc02008a6:	4681                	li	a3,0
    while (n >> 1)
ffffffffc02008a8:	8385                	srli	a5,a5,0x1
        order++;
ffffffffc02008aa:	2685                	addiw	a3,a3,1
    while (n >> 1)
ffffffffc02008ac:	fff5                	bnez	a5,ffffffffc02008a8 <buddy_system_pmm_alloc_pages+0x48>
    for (int order = order_needed; order <= MAX_ORDER; order++) {
ffffffffc02008ae:	47ad                	li	a5,11
    int order_needed = getorder(getup2(n)); // 找到需要的最小阶层
ffffffffc02008b0:	0006849b          	sext.w	s1,a3
    for (int order = order_needed; order <= MAX_ORDER; order++) {
ffffffffc02008b4:	02d7c663          	blt	a5,a3,ffffffffc02008e0 <buddy_system_pmm_alloc_pages+0x80>
        if (buddy_zone.free_area[order].nr_free / (1 << order) > 0) {
ffffffffc02008b8:	00149713          	slli	a4,s1,0x1
ffffffffc02008bc:	9726                	add	a4,a4,s1
ffffffffc02008be:	070e                	slli	a4,a4,0x3
ffffffffc02008c0:	974a                	add	a4,a4,s2
ffffffffc02008c2:	4b10                	lw	a2,16(a4)
ffffffffc02008c4:	009657bb          	srlw	a5,a2,s1
ffffffffc02008c8:	ef85                	bnez	a5,ffffffffc0200900 <buddy_system_pmm_alloc_pages+0xa0>
ffffffffc02008ca:	87a6                	mv	a5,s1
    for (int order = order_needed; order <= MAX_ORDER; order++) {
ffffffffc02008cc:	45b1                	li	a1,12
ffffffffc02008ce:	a031                	j	ffffffffc02008da <buddy_system_pmm_alloc_pages+0x7a>
        if (buddy_zone.free_area[order].nr_free / (1 << order) > 0) {
ffffffffc02008d0:	5710                	lw	a2,40(a4)
ffffffffc02008d2:	0761                	addi	a4,a4,24
ffffffffc02008d4:	00f656bb          	srlw	a3,a2,a5
ffffffffc02008d8:	e68d                	bnez	a3,ffffffffc0200902 <buddy_system_pmm_alloc_pages+0xa2>
    for (int order = order_needed; order <= MAX_ORDER; order++) {
ffffffffc02008da:	2785                	addiw	a5,a5,1
ffffffffc02008dc:	feb79ae3          	bne	a5,a1,ffffffffc02008d0 <buddy_system_pmm_alloc_pages+0x70>
        return NULL;
ffffffffc02008e0:	4401                	li	s0,0
}
ffffffffc02008e2:	70e2                	ld	ra,56(sp)
ffffffffc02008e4:	8522                	mv	a0,s0
ffffffffc02008e6:	7442                	ld	s0,48(sp)
ffffffffc02008e8:	74a2                	ld	s1,40(sp)
ffffffffc02008ea:	7902                	ld	s2,32(sp)
ffffffffc02008ec:	69e2                	ld	s3,24(sp)
ffffffffc02008ee:	6a42                	ld	s4,16(sp)
ffffffffc02008f0:	6aa2                	ld	s5,8(sp)
ffffffffc02008f2:	6121                	addi	sp,sp,64
ffffffffc02008f4:	8082                	ret
    while (n >> 1)
ffffffffc02008f6:	00155793          	srli	a5,a0,0x1
ffffffffc02008fa:	b775                	j	ffffffffc02008a6 <buddy_system_pmm_alloc_pages+0x46>
    int order_needed = getorder(getup2(n)); // 找到需要的最小阶层
ffffffffc02008fc:	4481                	li	s1,0
ffffffffc02008fe:	bf6d                	j	ffffffffc02008b8 <buddy_system_pmm_alloc_pages+0x58>
        if (buddy_zone.free_area[order].nr_free / (1 << order) > 0) {
ffffffffc0200900:	87a6                	mv	a5,s1
...
list_next(list_entry_t *listelm) {
    return listelm->next;
ffffffffc0200902:	00179693          	slli	a3,a5,0x1
ffffffffc0200906:	00f68733          	add	a4,a3,a5
ffffffffc020090a:	070e                	slli	a4,a4,0x3
ffffffffc020090c:	974a                	add	a4,a4,s2
ffffffffc020090e:	6708                	ld	a0,8(a4)
            buddy_zone.free_area[order].nr_free-=(1<<order);
ffffffffc0200910:	4585                	li	a1,1
ffffffffc0200912:	00f59a3b          	sllw	s4,a1,a5
    __list_del(listelm->prev, listelm->next);
ffffffffc0200916:	00053883          	ld	a7,0(a0)
ffffffffc020091a:	00853803          	ld	a6,8(a0)
ffffffffc020091e:	4146063b          	subw	a2,a2,s4
            struct Page *p = le2page(le, page_link);
ffffffffc0200922:	fe850413          	addi	s0,a0,-24
...
__list_del(list_entry_t *prev, list_entry_t *next) {
    prev->next = next;
ffffffffc0200926:	0108b423          	sd	a6,8(a7)
    next->prev = prev;
ffffffffc020092a:	01183023          	sd	a7,0(a6)
            buddy_zone.free_area[order].nr_free-=(1<<order);
ffffffffc020092e:	cb10                	sw	a2,16(a4)
...
ffffffffc0200930:	5775                	li	a4,-3
ffffffffc0200932:	ff050613          	addi	a2,a0,-16
ffffffffc0200936:	60e6302f          	amoand.d	zero,a4,(a2)
    if(n==1)
ffffffffc020093a:	4705                	li	a4,1
ffffffffc020093c:	0ae98963          	beq	s3,a4,ffffffffc02009ee <buddy_system_pmm_alloc_pages+0x18e>
    if (n & (n - 1)) return 0;
ffffffffc0200940:	fff98713          	addi	a4,s3,-1
ffffffffc0200944:	01377733          	and	a4,a4,s3
ffffffffc0200948:	c35d                	beqz	a4,ffffffffc02009ee <buddy_system_pmm_alloc_pages+0x18e>
                cprintf("begin");
ffffffffc020094a:	00002517          	auipc	a0,0x2
ffffffffc020094e:	9e650513          	addi	a0,a0,-1562 # ffffffffc0202330 <commands+0x538>
ffffffffc0200952:	f60ff0ef          	jal	ra,ffffffffc02000b2 <cprintf>
                size_t excess_pages = (1 << order) - n; 
ffffffffc0200956:	413a0ab3          	sub	s5,s4,s3
                while (excess_pages > 0) {
ffffffffc020095a:	093a0563          	beq	s4,s3,ffffffffc02009e4 <buddy_system_pmm_alloc_pages+0x184>
                    buddy+=1<<highest_pow2;
ffffffffc020095e:	4a05                	li	s4,1
    __op_bit(or, __NOP, nr, ((volatile unsigned long *)addr));
ffffffffc0200960:	4989                	li	s3,2
                    int highest_pow2 = getdown2(excess_pages); // 找到不超过 excess_pages 的最大 2 的幂
ffffffffc0200962:	8556                	mv	a0,s5
ffffffffc0200964:	edfff0ef          	jal	ra,ffffffffc0200842 <getdown2>
ffffffffc0200968:	2501                	sext.w	a0,a0
                    buddy+=1<<highest_pow2;
ffffffffc020096a:	00aa173b          	sllw	a4,s4,a0
ffffffffc020096e:	00271793          	slli	a5,a4,0x2
ffffffffc0200972:	97ba                	add	a5,a5,a4
ffffffffc0200974:	8622                	mv	a2,s0
ffffffffc0200976:	078e                	slli	a5,a5,0x3
ffffffffc0200978:	943e                	add	s0,s0,a5
                    excess_pages -= highest_pow2;
ffffffffc020097a:	40aa8ab3          	sub	s5,s5,a0
                    extra_buddy->property = highest_pow2;
ffffffffc020097e:	ca08                	sw	a0,16(a2)
ffffffffc0200980:	00860793          	addi	a5,a2,8
ffffffffc0200984:	4137b02f          	amoor.d	zero,s3,(a5)
    while (n >> 1)
ffffffffc0200988:	00155793          	srli	a5,a0,0x1
                    list_add(&buddy_zone.free_area[getorder(highest_pow2)].free_list, &extra_buddy->page_link);
ffffffffc020098c:	01860593          	addi	a1,a2,24
    while (n >> 1)
ffffffffc0200990:	c3e9                	beqz	a5,ffffffffc0200a52 <buddy_system_pmm_alloc_pages+0x1f2>
ffffffffc0200992:	873e                	mv	a4,a5
    unsigned int order = 0;
ffffffffc0200994:	4681                	li	a3,0
    while (n >> 1)
ffffffffc0200996:	8305                	srli	a4,a4,0x1
        order++;
ffffffffc0200998:	2685                	addiw	a3,a3,1
    while (n >> 1)
ffffffffc020099a:	ff75                	bnez	a4,ffffffffc0200996 <buddy_system_pmm_alloc_pages+0x136>
    __list_add(elm, listelm, listelm->next);
ffffffffc020099c:	1682                	slli	a3,a3,0x20
ffffffffc020099e:	9281                	srli	a3,a3,0x20
ffffffffc02009a0:	00169713          	slli	a4,a3,0x1
ffffffffc02009a4:	96ba                	add	a3,a3,a4
ffffffffc02009a6:	068e                	slli	a3,a3,0x3
ffffffffc02009a8:	96ca                	add	a3,a3,s2
ffffffffc02009aa:	0086b803          	ld	a6,8(a3)
    elm->prev = prev;
ffffffffc02009ae:	4701                	li	a4,0
    prev->next = next->prev = elm;
ffffffffc02009b0:	00b83023          	sd	a1,0(a6)
ffffffffc02009b4:	e68c                	sd	a1,8(a3)
    elm->next = next;
ffffffffc02009b6:	03063023          	sd	a6,32(a2)
    elm->prev = prev;
ffffffffc02009ba:	ee14                	sd	a3,24(a2)
ffffffffc02009bc:	8385                	srli	a5,a5,0x1
        order++;
ffffffffc02009be:	2705                	addiw	a4,a4,1
    while (n >> 1)
ffffffffc02009c0:	fff5                	bnez	a5,ffffffffc02009bc <buddy_system_pmm_alloc_pages+0x15c>
                    buddy_zone.free_area[getorder(highest_pow2)].nr_free += highest_pow2;
ffffffffc02009c2:	1702                	slli	a4,a4,0x20
ffffffffc02009c4:	9301                	srli	a4,a4,0x20
ffffffffc02009c6:	00171793          	slli	a5,a4,0x1
ffffffffc02009ca:	973e                	add	a4,a4,a5
ffffffffc02009cc:	070e                	slli	a4,a4,0x3
ffffffffc02009ce:	974a                	add	a4,a4,s2
ffffffffc02009d0:	4b14                	lw	a3,16(a4)
                    buddy_zone.n_sum+=highest_pow2;
ffffffffc02009d2:	10893783          	ld	a5,264(s2)
                    buddy_zone.free_area[getorder(highest_pow2)].nr_free += highest_pow2;
ffffffffc02009d6:	9ea9                	addw	a3,a3,a0
                    buddy_zone.n_sum+=highest_pow2;
ffffffffc02009d8:	953e                	add	a0,a0,a5
                    buddy_zone.free_area[getorder(highest_pow2)].nr_free += highest_pow2;
ffffffffc02009da:	cb14                	sw	a3,16(a4)
                    buddy_zone.n_sum+=highest_pow2;
ffffffffc02009dc:	10a93423          	sd	a0,264(s2)
                while (excess_pages > 0) {
ffffffffc02009e0:	f80a91e3          	bnez	s5,ffffffffc0200962 <buddy_system_pmm_alloc_pages+0x102>
                p->property=1<<order_copy;
ffffffffc02009e4:	4785                	li	a5,1
ffffffffc02009e6:	009794bb          	sllw	s1,a5,s1
ffffffffc02009ea:	c804                	sw	s1,16(s0)
                return p;
ffffffffc02009ec:	bddd                	j	ffffffffc02008e2 <buddy_system_pmm_alloc_pages+0x82>
            int n_more=(1<<order)-(1<<order_needed);
ffffffffc02009ee:	4e05                	li	t3,1
ffffffffc02009f0:	009e1ebb          	sllw	t4,t3,s1
ffffffffc02009f4:	8e76                	mv	t3,t4
            while (order > order_needed) {
ffffffffc02009f6:	04f4d663          	bge	s1,a5,ffffffffc0200a42 <buddy_system_pmm_alloc_pages+0x1e2>
ffffffffc02009fa:	00f68733          	add	a4,a3,a5
ffffffffc02009fe:	070e                	slli	a4,a4,0x3
ffffffffc0200a00:	1721                	addi	a4,a4,-24
ffffffffc0200a02:	974a                	add	a4,a4,s2
                buddy->property = 1 << order;
ffffffffc0200a04:	4305                	li	t1,1
ffffffffc0200a06:	4889                	li	a7,2
                order--;
ffffffffc0200a08:	37fd                	addiw	a5,a5,-1
                buddy->property = 1 << order;
ffffffffc0200a0a:	00f3153b          	sllw	a0,t1,a5
ffffffffc0200a0e:	c808                	sw	a0,16(s0)
ffffffffc0200a10:	00840693          	addi	a3,s0,8
ffffffffc0200a14:	4116b02f          	amoor.d	zero,a7,(a3)
    __list_add(elm, listelm, listelm->next);
ffffffffc0200a18:	00873803          	ld	a6,8(a4)
                buddy_zone.free_area[order].nr_free+=1<<order;
ffffffffc0200a1c:	4b10                	lw	a2,16(a4)
                list_add(&buddy_zone.free_area[order].free_list, &buddy->page_link);
ffffffffc0200a1e:	01840693          	addi	a3,s0,24
    prev->next = next->prev = elm;
ffffffffc0200a22:	00d83023          	sd	a3,0(a6)
ffffffffc0200a26:	e714                	sd	a3,8(a4)
                buddy += (1 << order);
ffffffffc0200a28:	00251693          	slli	a3,a0,0x2
    elm->prev = prev;
ffffffffc0200a2c:	ec18                	sd	a4,24(s0)
    elm->next = next;
ffffffffc0200a2e:	03043023          	sd	a6,32(s0)
ffffffffc0200a32:	96aa                	add	a3,a3,a0
                buddy_zone.free_area[order].nr_free+=1<<order;
ffffffffc0200a34:	9e29                	addw	a2,a2,a0
                buddy += (1 << order);
ffffffffc0200a36:	068e                	slli	a3,a3,0x3
                buddy_zone.free_area[order].nr_free+=1<<order;
ffffffffc0200a38:	cb10                	sw	a2,16(a4)
                buddy += (1 << order);
ffffffffc0200a3a:	9436                	add	s0,s0,a3
            while (order > order_needed) {
ffffffffc0200a3c:	1721                	addi	a4,a4,-24
ffffffffc0200a3e:	fc9795e3          	bne	a5,s1,ffffffffc0200a08 <buddy_system_pmm_alloc_pages+0x1a8>
            p=buddy+(1<<order_needed);
ffffffffc0200a42:	002e9793          	slli	a5,t4,0x2
ffffffffc0200a46:	97f6                	add	a5,a5,t4
ffffffffc0200a48:	078e                	slli	a5,a5,0x3
ffffffffc0200a4a:	943e                	add	s0,s0,a5
            p->property=1<<order_copy;
ffffffffc0200a4c:	01c42823          	sw	t3,16(s0)
            return p;
ffffffffc0200a50:	bd49                	j	ffffffffc02008e2 <buddy_system_pmm_alloc_pages+0x82>
    __list_add(elm, listelm, listelm->next);
ffffffffc0200a52:	00893783          	ld	a5,8(s2)
    unsigned int order = 0;
ffffffffc0200a56:	4701                	li	a4,0
    prev->next = next->prev = elm;
ffffffffc0200a58:	e38c                	sd	a1,0(a5)
ffffffffc0200a5a:	00b93423          	sd	a1,8(s2)
    elm->next = next;
ffffffffc0200a5e:	f21c                	sd	a5,32(a2)
    elm->prev = prev;
ffffffffc0200a60:	01263c23          	sd	s2,24(a2)
    while (n >> 1)
ffffffffc0200a64:	bfb9                	j	ffffffffc02009c2 <buddy_system_pmm_alloc_pages+0x162>
    assert(n > 0);
ffffffffc0200a66:	00002697          	auipc	a3,0x2
ffffffffc0200a6a:	88a68693          	addi	a3,a3,-1910 # ffffffffc02022f0 <commands+0x4f8>
ffffffffc0200a6e:	00002617          	auipc	a2,0x2
ffffffffc0200a72:	88a60613          	addi	a2,a2,-1910 # ffffffffc02022f8 <commands+0x500>
ffffffffc0200a76:	0f200593          	li	a1,242
ffffffffc0200a7a:	00002517          	auipc	a0,0x2
ffffffffc0200a7e:	89650513          	addi	a0,a0,-1898 # ffffffffc0202310 <commands+0x518>
ffffffffc0200a82:	92bff0ef          	jal	ra,ffffffffc02003ac <__panic>

ffffffffc0200a86 <buddy_system_pmm_init_memmap>:
static void buddy_system_pmm_init_memmap(struct Page *base, size_t n) {
ffffffffc0200a86:	715d                	addi	sp,sp,-80
ffffffffc0200a88:	e486                	sd	ra,72(sp)
ffffffffc0200a8a:	e0a2                	sd	s0,64(sp)
ffffffffc0200a8c:	fc26                	sd	s1,56(sp)
ffffffffc0200a8e:	f84a                	sd	s2,48(sp)
ffffffffc0200a90:	f44e                	sd	s3,40(sp)
ffffffffc0200a92:	f052                	sd	s4,32(sp)
ffffffffc0200a94:	ec56                	sd	s5,24(sp)
ffffffffc0200a96:	e85a                	sd	s6,16(sp)
ffffffffc0200a98:	e45e                	sd	s7,8(sp)
ffffffffc0200a9a:	e062                	sd	s8,0(sp)
    assert(n > 0);
ffffffffc0200a9c:	1e058c63          	beqz	a1,ffffffffc0200c94 <buddy_system_pmm_init_memmap+0x20e>
    for (; p != base + n; p++) {
ffffffffc0200aa0:	00259693          	slli	a3,a1,0x2
ffffffffc0200aa4:	96ae                	add	a3,a3,a1
ffffffffc0200aa6:	068e                	slli	a3,a3,0x3
ffffffffc0200aa8:	96aa                	add	a3,a3,a0
ffffffffc0200aaa:	8a2a                	mv	s4,a0
ffffffffc0200aac:	87aa                	mv	a5,a0
ffffffffc0200aae:	02d50063          	beq	a0,a3,ffffffffc0200ace <buddy_system_pmm_init_memmap+0x48>
...
ffffffffc0200ab2:	6798                	ld	a4,8(a5)
        assert(PageReserved(p));
ffffffffc0200ab4:	8b05                	andi	a4,a4,1
ffffffffc0200ab6:	1a070f63          	beqz	a4,ffffffffc0200c74 <buddy_system_pmm_init_memmap+0x1ee>
        p->flags = p->property = 0;
ffffffffc0200aba:	0007a823          	sw	zero,16(a5)
ffffffffc0200abe:	0007b423          	sd	zero,8(a5)
...
ffffffffc0200ac2:	0007a023          	sw	zero,0(a5)
    for (; p != base + n; p++) {
ffffffffc0200ac6:	02878793          	addi	a5,a5,40
ffffffffc0200aca:	fed794e3          	bne	a5,a3,ffffffffc0200ab2 <buddy_system_pmm_init_memmap+0x2c>
    buddy_zone.n_sum += n;
ffffffffc0200ace:	00005497          	auipc	s1,0x5
ffffffffc0200ad2:	54248493          	addi	s1,s1,1346 # ffffffffc0206010 <buddy_zone>
ffffffffc0200ad6:	1084b783          	ld	a5,264(s1)
    int n_now = n;
ffffffffc0200ada:	00058a9b          	sext.w	s5,a1
    buddy_zone.n_sum += n;
ffffffffc0200ade:	95be                	add	a1,a1,a5
ffffffffc0200ae0:	10b4b423          	sd	a1,264(s1)
    while (n_now != 0) {
ffffffffc0200ae4:	080a8463          	beqz	s5,ffffffffc0200b6c <buddy_system_pmm_init_memmap+0xe6>
    __op_bit(or, __NOP, nr, ((volatile unsigned long *)addr));
ffffffffc0200ae8:	4b09                	li	s6,2
        if (order == MAX_ORDER - 1) {
ffffffffc0200aea:	4925                	li	s2,9
            for (int i = 0; i < num_blocks; i++) {
ffffffffc0200aec:	3ff00993          	li	s3,1023
ffffffffc0200af0:	00005417          	auipc	s0,0x5
ffffffffc0200af4:	61040413          	addi	s0,s0,1552 # ffffffffc0206100 <buddy_zone+0xf0>
                now_page->property = max_block_size; // 每个块的页数
ffffffffc0200af8:	40000c13          	li	s8,1024
                now_page += max_block_size; // 更新当前页指针
ffffffffc0200afc:	6ba9                	lui	s7,0xa
        int n_temp = getdown2(n_now);
ffffffffc0200afe:	8556                	mv	a0,s5
ffffffffc0200b00:	d43ff0ef          	jal	ra,ffffffffc0200842 <getdown2>
ffffffffc0200b04:	2501                	sext.w	a0,a0
    while (n >> 1)
ffffffffc0200b06:	00155793          	srli	a5,a0,0x1
ffffffffc0200b0a:	14078863          	beqz	a5,ffffffffc0200c5a <buddy_system_pmm_init_memmap+0x1d4>
    unsigned int order = 0;
ffffffffc0200b0e:	4701                	li	a4,0
    while (n >> 1)
ffffffffc0200b10:	8385                	srli	a5,a5,0x1
        order++;
ffffffffc0200b12:	2705                	addiw	a4,a4,1
    while (n >> 1)
ffffffffc0200b14:	fff5                	bnez	a5,ffffffffc0200b10 <buddy_system_pmm_init_memmap+0x8a>
        int order = getorder(n_temp);
ffffffffc0200b16:	0007059b          	sext.w	a1,a4
        if (order == MAX_ORDER - 1) {
ffffffffc0200b1a:	08e94763          	blt	s2,a4,ffffffffc0200ba8 <buddy_system_pmm_init_memmap+0x122>
            list_entry_t *free_list_order = &buddy_zone.free_area[order].free_list;
ffffffffc0200b1e:	00159793          	slli	a5,a1,0x1
ffffffffc0200b22:	00b786b3          	add	a3,a5,a1
ffffffffc0200b26:	068e                	slli	a3,a3,0x3
ffffffffc0200b28:	96a6                	add	a3,a3,s1
            now_page += n_temp; // 更新当前页指针
ffffffffc0200b2a:	00251613          	slli	a2,a0,0x2
ffffffffc0200b2e:	962a                	add	a2,a2,a0
ffffffffc0200b30:	060e                	slli	a2,a2,0x3
ffffffffc0200b32:	9a32                	add	s4,s4,a2
            n_now -= n_temp;
ffffffffc0200b34:	40aa8abb          	subw	s5,s5,a0
            now_page->property = n_temp;
ffffffffc0200b38:	00aa2823          	sw	a0,16(s4)
ffffffffc0200b3c:	008a0713          	addi	a4,s4,8
ffffffffc0200b40:	4167302f          	amoor.d	zero,s6,(a4)
            buddy_zone.free_area[order].nr_free += n_temp;
ffffffffc0200b44:	00b78733          	add	a4,a5,a1
ffffffffc0200b48:	070e                	slli	a4,a4,0x3
ffffffffc0200b4a:	9726                	add	a4,a4,s1
ffffffffc0200b4c:	4b10                	lw	a2,16(a4)
    return list->next == list;
ffffffffc0200b4e:	671c                	ld	a5,8(a4)
                list_add(free_list_order, &now_page->page_link);
ffffffffc0200b50:	018a0593          	addi	a1,s4,24
            buddy_zone.free_area[order].nr_free += n_temp;
ffffffffc0200b54:	9d31                	addw	a0,a0,a2
ffffffffc0200b56:	cb08                	sw	a0,16(a4)
            if (list_empty(free_list_order)) {
ffffffffc0200b58:	02f69a63          	bne	a3,a5,ffffffffc0200b8c <buddy_system_pmm_init_memmap+0x106>
    prev->next = next->prev = elm;
ffffffffc0200b5c:	e28c                	sd	a1,0(a3)
ffffffffc0200b5e:	e70c                	sd	a1,8(a4)
    elm->next = next;
ffffffffc0200b60:	02da3023          	sd	a3,32(s4)
    elm->prev = prev;
ffffffffc0200b64:	00da3c23          	sd	a3,24(s4)
    while (n_now != 0) {
ffffffffc0200b68:	f80a9be3          	bnez	s5,ffffffffc0200afe <buddy_system_pmm_init_memmap+0x78>
}
ffffffffc0200b6c:	60a6                	ld	ra,72(sp)
ffffffffc0200b6e:	6406                	ld	s0,64(sp)
ffffffffc0200b70:	74e2                	ld	s1,56(sp)
ffffffffc0200b72:	7942                	ld	s2,48(sp)
ffffffffc0200b74:	79a2                	ld	s3,40(sp)
ffffffffc0200b76:	7a02                	ld	s4,32(sp)
ffffffffc0200b78:	6ae2                	ld	s5,24(sp)
ffffffffc0200b7a:	6b42                	ld	s6,16(sp)
ffffffffc0200b7c:	6ba2                	ld	s7,8(sp)
ffffffffc0200b7e:	6c02                	ld	s8,0(sp)
ffffffffc0200b80:	6161                	addi	sp,sp,80
ffffffffc0200b82:	8082                	ret
    return listelm->next;
ffffffffc0200b84:	6798                	ld	a4,8(a5)
                    } else if (list_next(le) == free_list_order) {
ffffffffc0200b86:	0ce68e63          	beq	a3,a4,ffffffffc0200c62 <buddy_system_pmm_init_memmap+0x1dc>
ffffffffc0200b8a:	87ba                	mv	a5,a4
                    struct Page *page = le2page(le, page_link);
ffffffffc0200b8c:	fe878713          	addi	a4,a5,-24
                    if (now_page < page) {
ffffffffc0200b90:	feea7ae3          	bgeu	s4,a4,ffffffffc0200b84 <buddy_system_pmm_init_memmap+0xfe>
    __list_add(elm, listelm->prev, listelm);
ffffffffc0200b94:	6398                	ld	a4,0(a5)
    prev->next = next->prev = elm;
ffffffffc0200b96:	e38c                	sd	a1,0(a5)
ffffffffc0200b98:	e70c                	sd	a1,8(a4)
    elm->next = next;
ffffffffc0200b9a:	02fa3023          	sd	a5,32(s4)
    elm->prev = prev;
ffffffffc0200b9e:	00ea3c23          	sd	a4,24(s4)
    while (n_now != 0) {
ffffffffc0200ba2:	f40a9ee3          	bnez	s5,ffffffffc0200afe <buddy_system_pmm_init_memmap+0x78>
ffffffffc0200ba6:	b7d9                	j	ffffffffc0200b6c <buddy_system_pmm_init_memmap+0xe6>
            int num_blocks = n_now / max_block_size; // 计算需要的最大块数
ffffffffc0200ba8:	41fad89b          	sraiw	a7,s5,0x1f
ffffffffc0200bac:	0168d51b          	srliw	a0,a7,0x16
ffffffffc0200bb0:	0155053b          	addw	a0,a0,s5
ffffffffc0200bb4:	40a5581b          	sraiw	a6,a0,0xa
ffffffffc0200bb8:	8542                	mv	a0,a6
            for (int i = 0; i < num_blocks; i++) {
ffffffffc0200bba:	0959d063          	bge	s3,s5,ffffffffc0200c3a <buddy_system_pmm_init_memmap+0x1b4>
ffffffffc0200bbe:	86d2                	mv	a3,s4
ffffffffc0200bc0:	4601                	li	a2,0
ffffffffc0200bc2:	a809                	j	ffffffffc0200bd4 <buddy_system_pmm_init_memmap+0x14e>
    prev->next = next->prev = elm;
ffffffffc0200bc4:	f8ec                	sd	a1,240(s1)
ffffffffc0200bc6:	fcec                	sd	a1,248(s1)
    elm->next = next;
ffffffffc0200bc8:	f280                	sd	s0,32(a3)
    elm->prev = prev;
ffffffffc0200bca:	ee80                	sd	s0,24(a3)
ffffffffc0200bcc:	2605                	addiw	a2,a2,1
                now_page += max_block_size; // 更新当前页指针
ffffffffc0200bce:	96de                	add	a3,a3,s7
            for (int i = 0; i < num_blocks; i++) {
ffffffffc0200bd0:	05065863          	bge	a2,a6,ffffffffc0200c20 <buddy_system_pmm_init_memmap+0x19a>
                now_page->property = max_block_size; // 每个块的页数
ffffffffc0200bd4:	0186a823          	sw	s8,16(a3)
ffffffffc0200bd8:	00868793          	addi	a5,a3,8
ffffffffc0200bdc:	4167b02f          	amoor.d	zero,s6,(a5)
                buddy_zone.free_area[MAX_ORDER - 1].nr_free += max_block_size; // 更新 free_area 中的块数
ffffffffc0200be0:	1004a703          	lw	a4,256(s1)
    return list->next == list;
ffffffffc0200be4:	7cfc                	ld	a5,248(s1)
ffffffffc0200be6:	01868593          	addi	a1,a3,24
ffffffffc0200bea:	4007071b          	addiw	a4,a4,1024
ffffffffc0200bee:	10e4a023          	sw	a4,256(s1)
                if (list_empty(free_list_order)) {
ffffffffc0200bf2:	fc8789e3          	beq	a5,s0,ffffffffc0200bc4 <buddy_system_pmm_init_memmap+0x13e>
                        struct Page *page = le2page(le, page_link);
ffffffffc0200bf6:	fe878713          	addi	a4,a5,-24
                        if (now_page < page) {
ffffffffc0200bfa:	00e6ea63          	bltu	a3,a4,ffffffffc0200c0e <buddy_system_pmm_init_memmap+0x188>
    return listelm->next;
ffffffffc0200bfe:	6798                	ld	a4,8(a5)
                        } else if (list_next(le) == free_list_order) {
ffffffffc0200c00:	04870863          	beq	a4,s0,ffffffffc0200c50 <buddy_system_pmm_init_memmap+0x1ca>
ffffffffc0200c04:	87ba                	mv	a5,a4
                        struct Page *page = le2page(le, page_link);
ffffffffc0200c06:	fe878713          	addi	a4,a5,-24
                        if (now_page < page) {
ffffffffc0200c0a:	fee6fae3          	bgeu	a3,a4,ffffffffc0200bfe <buddy_system_pmm_init_memmap+0x178>
    __list_add(elm, listelm->prev, listelm);
ffffffffc0200c0e:	6398                	ld	a4,0(a5)
    prev->next = next->prev = elm;
ffffffffc0200c10:	e38c                	sd	a1,0(a5)
            for (int i = 0; i < num_blocks; i++) {
ffffffffc0200c12:	2605                	addiw	a2,a2,1
ffffffffc0200c14:	e70c                	sd	a1,8(a4)
    elm->next = next;
ffffffffc0200c16:	f29c                	sd	a5,32(a3)
    elm->prev = prev;
ffffffffc0200c18:	ee98                	sd	a4,24(a3)
                now_page += max_block_size; // 更新当前页指针
ffffffffc0200c1a:	96de                	add	a3,a3,s7
            for (int i = 0; i < num_blocks; i++) {
ffffffffc0200c1c:	fb064ce3          	blt	a2,a6,ffffffffc0200bd4 <buddy_system_pmm_init_memmap+0x14e>
                now_page += max_block_size; // 更新当前页指针
ffffffffc0200c20:	67a9                	lui	a5,0xa
ffffffffc0200c22:	0159db63          	bge	s3,s5,ffffffffc0200c38 <buddy_system_pmm_init_memmap+0x1b2>
ffffffffc0200c26:	fff5079b          	addiw	a5,a0,-1
ffffffffc0200c2a:	1782                	slli	a5,a5,0x20
ffffffffc0200c2c:	9381                	srli	a5,a5,0x20
ffffffffc0200c2e:	0785                	addi	a5,a5,1
ffffffffc0200c30:	00279713          	slli	a4,a5,0x2
ffffffffc0200c34:	97ba                	add	a5,a5,a4
ffffffffc0200c36:	07b6                	slli	a5,a5,0xd
ffffffffc0200c38:	9a3e                	add	s4,s4,a5
            n_now -= num_blocks * max_block_size; // 更新剩余页数
ffffffffc0200c3a:	0168d79b          	srliw	a5,a7,0x16
ffffffffc0200c3e:	01578abb          	addw	s5,a5,s5
ffffffffc0200c42:	3ffafa93          	andi	s5,s5,1023
ffffffffc0200c46:	40fa8abb          	subw	s5,s5,a5
    while (n_now != 0) {
ffffffffc0200c4a:	ea0a9ae3          	bnez	s5,ffffffffc0200afe <buddy_system_pmm_init_memmap+0x78>
ffffffffc0200c4e:	bf39                	j	ffffffffc0200b6c <buddy_system_pmm_init_memmap+0xe6>
    prev->next = next->prev = elm;
ffffffffc0200c50:	f8ec                	sd	a1,240(s1)
ffffffffc0200c52:	e78c                	sd	a1,8(a5)
    elm->next = next;
ffffffffc0200c54:	f280                	sd	s0,32(a3)
    elm->prev = prev;
ffffffffc0200c56:	ee9c                	sd	a5,24(a3)
}
ffffffffc0200c58:	bf95                	j	ffffffffc0200bcc <buddy_system_pmm_init_memmap+0x146>
    while (n >> 1)
ffffffffc0200c5a:	86a6                	mv	a3,s1
        int order = getorder(n_temp);
ffffffffc0200c5c:	4581                	li	a1,0
ffffffffc0200c5e:	4781                	li	a5,0
ffffffffc0200c60:	b5e9                	j	ffffffffc0200b2a <buddy_system_pmm_init_memmap+0xa4>
    prev->next = next->prev = elm;
ffffffffc0200c62:	e28c                	sd	a1,0(a3)
ffffffffc0200c64:	e78c                	sd	a1,8(a5)
    elm->next = next;
ffffffffc0200c66:	02da3023          	sd	a3,32(s4)
    elm->prev = prev;
ffffffffc0200c6a:	00fa3c23          	sd	a5,24(s4)
    while (n_now != 0) {
ffffffffc0200c6e:	e80a98e3          	bnez	s5,ffffffffc0200afe <buddy_system_pmm_init_memmap+0x78>
ffffffffc0200c72:	bded                	j	ffffffffc0200b6c <buddy_system_pmm_init_memmap+0xe6>
        assert(PageReserved(p));
ffffffffc0200c74:	00001697          	auipc	a3,0x1
ffffffffc0200c78:	6c468693          	addi	a3,a3,1732 # ffffffffc0202338 <commands+0x540>
ffffffffc0200c7c:	00001617          	auipc	a2,0x1
ffffffffc0200c80:	67c60613          	addi	a2,a2,1660 # ffffffffc02022f8 <commands+0x500>
ffffffffc0200c84:	09600593          	li	a1,150
ffffffffc0200c88:	00001517          	auipc	a0,0x1
ffffffffc0200c8c:	68850513          	addi	a0,a0,1672 # ffffffffc0202310 <commands+0x518>
ffffffffc0200c90:	f1cff0ef          	jal	ra,ffffffffc02003ac <__panic>
    assert(n > 0);
ffffffffc0200c94:	00001697          	auipc	a3,0x1
ffffffffc0200c98:	65c68693          	addi	a3,a3,1628 # ffffffffc02022f0 <commands+0x4f8>
ffffffffc0200c9c:	00001617          	auipc	a2,0x1
ffffffffc0200ca0:	65c60613          	addi	a2,a2,1628 # ffffffffc02022f8 <commands+0x500>
ffffffffc0200ca4:	09200593          	li	a1,146
ffffffffc0200ca8:	00001517          	auipc	a0,0x1
ffffffffc0200cac:	66850513          	addi	a0,a0,1640 # ffffffffc0202310 <commands+0x518>
...
ffffffffc0200d3c:	fe878713          	addi	a4,a5,-24 # 9fe8 <kern_entry-0xffffffffc01f6018>
            if ((uintptr_t)current_page == (uintptr_t)p + page_size * block_size) {
...
ffffffffc0200e0c:	54050513          	addi	a0,a0,1344 # ffffffffc0202348 <commands+0x550>
            buddy_zone.n_sum += (1 << order);
...
ffffffffc0200e4e:	14000593          	li	a1,320
...
ffffffffc0200e68:	4ec50513          	addi	a0,a0,1260 # ffffffffc0202350 <commands+0x558>
static void buddy_system_pmm_check(void) {
...
ffffffffc0200eac:	4e850513          	addi	a0,a0,1256 # ffffffffc0202390 <commands+0x598>
...
ffffffffc0200eb8:	4fc50513          	addi	a0,a0,1276 # ffffffffc02023b0 <commands+0x5b8>
ffffffffc0200ebc:	9f6ff0ef          	jal	ra,ffffffffc02000b2 <cprintf>
    cprintf("[dbg_buddy] block: ");
ffffffffc0200ec0:	00001517          	auipc	a0,0x1
ffffffffc0200ec4:	51050513          	addi	a0,a0,1296 # ffffffffc02023d0 <commands+0x5d8>
...
ffffffffc0200edc:	51098993          	addi	s3,s3,1296 # ffffffffc02023e8 <commands+0x5f0>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc0200f0a:	4ea50513          	addi	a0,a0,1258 # ffffffffc02023f0 <commands+0x5f8>
...
ffffffffc0200f1e:	51e48493          	addi	s1,s1,1310 # ffffffffc0202438 <commands+0x640>
        pages[i] = alloc_pages(1);
...
ffffffffc0200f48:	514d0d13          	addi	s10,s10,1300 # ffffffffc0202458 <commands+0x660>
            cprintf("    %016lx (property: %d) --> \n", (size_t)page, page->property);
ffffffffc0200f4c:	00001917          	auipc	s2,0x1
ffffffffc0200f50:	53490913          	addi	s2,s2,1332 # ffffffffc0202480 <commands+0x688>
        cprintf("    NULL\n\n"); // 加入换行
ffffffffc0200f54:	00001c97          	auipc	s9,0x1
ffffffffc0200f58:	54cc8c93          	addi	s9,s9,1356 # ffffffffc02024a0 <commands+0x6a8>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc0200f94:	52050513          	addi	a0,a0,1312 # ffffffffc02024b0 <commands+0x6b8>
...
ffffffffc0200faa:	52a98993          	addi	s3,s3,1322 # ffffffffc02024d0 <commands+0x6d8>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc0200fd6:	f9cb8793          	addi	a5,s7,-100 # 9f9c <kern_entry-0xffffffffc01f6064>
ffffffffc0200fda:	3ef51e63          	bne	a0,a5,ffffffffc02013d6 <buddy_system_pmm_check+0x576>

    cprintf("[buddy_check] after alloc:  ");
ffffffffc0200fde:	00001517          	auipc	a0,0x1
ffffffffc0200fe2:	55250513          	addi	a0,a0,1362 # ffffffffc0202530 <commands+0x738>
ffffffffc0200fe6:	8ccff0ef          	jal	ra,ffffffffc02000b2 <cprintf>
    cprintf("[dbg_buddy] block: ");
ffffffffc0200fea:	00001517          	auipc	a0,0x1
ffffffffc0200fee:	3e650513          	addi	a0,a0,998 # ffffffffc02023d0 <commands+0x5d8>
...
ffffffffc0201004:	3e898993          	addi	s3,s3,1000 # ffffffffc02023e8 <commands+0x5f0>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc020102e:	526d0d13          	addi	s10,s10,1318 # ffffffffc0202550 <commands+0x758>
    cprintf("[dbg_buddy] block: ");
ffffffffc0201032:	00001c97          	auipc	s9,0x1
ffffffffc0201036:	39ec8c93          	addi	s9,s9,926 # ffffffffc02023d0 <commands+0x5d8>
        cprintf("%2d ", buddy_zone.free_area[order].nr_free / (1 << order));
ffffffffc020103a:	00001997          	auipc	s3,0x1
ffffffffc020103e:	3ae98993          	addi	s3,s3,942 # ffffffffc02023e8 <commands+0x5f0>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc0201092:	51250513          	addi	a0,a0,1298 # ffffffffc02025a0 <commands+0x7a8>
ffffffffc0201096:	81cff0ef          	jal	ra,ffffffffc02000b2 <cprintf>
    cprintf("[dbg_buddy] block: ");
ffffffffc020109a:	00001517          	auipc	a0,0x1
ffffffffc020109e:	33650513          	addi	a0,a0,822 # ffffffffc02023d0 <commands+0x5d8>
...
ffffffffc02010b4:	33898993          	addi	s3,s3,824 # ffffffffc02023e8 <commands+0x5f0>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc02010f4:	4f850513          	addi	a0,a0,1272 # ffffffffc02025e8 <commands+0x7f0>
ffffffffc02010f8:	fbbfe0ef          	jal	ra,ffffffffc02000b2 <cprintf>
    cprintf("[dbg_buddy] block: ");
ffffffffc02010fc:	00001517          	auipc	a0,0x1
ffffffffc0201100:	2d450513          	addi	a0,a0,724 # ffffffffc02023d0 <commands+0x5d8>
...
ffffffffc0201116:	2d698993          	addi	s3,s3,726 # ffffffffc02023e8 <commands+0x5f0>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc0201156:	4e650513          	addi	a0,a0,1254 # ffffffffc0202638 <commands+0x840>
ffffffffc020115a:	f59fe0ef          	jal	ra,ffffffffc02000b2 <cprintf>
    cprintf("[dbg_buddy] block: ");
ffffffffc020115e:	00001517          	auipc	a0,0x1
ffffffffc0201162:	27250513          	addi	a0,a0,626 # ffffffffc02023d0 <commands+0x5d8>
...
ffffffffc0201178:	27498993          	addi	s3,s3,628 # ffffffffc02023e8 <commands+0x5f0>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc02011b8:	4d450513          	addi	a0,a0,1236 # ffffffffc0202688 <commands+0x890>
ffffffffc02011bc:	ef7fe0ef          	jal	ra,ffffffffc02000b2 <cprintf>
    cprintf("[dbg_buddy] block: ");
ffffffffc02011c0:	00001517          	auipc	a0,0x1
ffffffffc02011c4:	21050513          	addi	a0,a0,528 # ffffffffc02023d0 <commands+0x5d8>
...
ffffffffc02011da:	21298993          	addi	s3,s3,530 # ffffffffc02023e8 <commands+0x5f0>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc0201214:	4c850513          	addi	a0,a0,1224 # ffffffffc02026d8 <commands+0x8e0>
ffffffffc0201218:	e9bfe0ef          	jal	ra,ffffffffc02000b2 <cprintf>
    cprintf("[dbg_buddy] block: ");
ffffffffc020121c:	00001517          	auipc	a0,0x1
ffffffffc0201220:	1b450513          	addi	a0,a0,436 # ffffffffc02023d0 <commands+0x5d8>
...
ffffffffc020122e:	1be90913          	addi	s2,s2,446 # ffffffffc02023e8 <commands+0x5f0>
    for (int order = MAX_ORDER - 1; order >= 0; order--) {
...
ffffffffc020128a:	47a50513          	addi	a0,a0,1146 # ffffffffc0202700 <commands+0x908>
}
...
ffffffffc02014b6:	2ae78793          	addi	a5,a5,686 # ffffffffc0202760 <buddy_system_pmm_manager>
...
ffffffffc02014c4:	2d850513          	addi	a0,a0,728 # ffffffffc0202798 <buddy_system_pmm_manager+0x38>
    pmm_manager = &buddy_system_pmm_manager;
...
ffffffffc02014f0:	2c450513          	addi	a0,a0,708 # ffffffffc02027b0 <buddy_system_pmm_manager+0x50>
    va_pa_offset = PHYSICAL_MEMORY_OFFSET;
...
ffffffffc020150e:	2be50513          	addi	a0,a0,702 # ffffffffc02027c8 <buddy_system_pmm_manager+0x68>
...
ffffffffc0201590:	2d450513          	addi	a0,a0,724 # ffffffffc0202860 <buddy_system_pmm_manager+0x100>
...
ffffffffc02015c8:	2bc50513          	addi	a0,a0,700 # ffffffffc0202880 <buddy_system_pmm_manager+0x120>
}
...
ffffffffc0201600:	23460613          	addi	a2,a2,564 # ffffffffc0202830 <buddy_system_pmm_manager+0xd0>
ffffffffc0201604:	06b00593          	li	a1,107
ffffffffc0201608:	00001517          	auipc	a0,0x1
ffffffffc020160c:	24850513          	addi	a0,a0,584 # ffffffffc0202850 <buddy_system_pmm_manager+0xf0>
ffffffffc0201610:	d9dfe0ef          	jal	ra,ffffffffc02003ac <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0201614:	00001617          	auipc	a2,0x1
ffffffffc0201618:	1e460613          	addi	a2,a2,484 # ffffffffc02027f8 <buddy_system_pmm_manager+0x98>
ffffffffc020161c:	07200593          	li	a1,114
ffffffffc0201620:	00001517          	auipc	a0,0x1
ffffffffc0201624:	20050513          	addi	a0,a0,512 # ffffffffc0202820 <buddy_system_pmm_manager+0xc0>
...
ffffffffc0201632:	1ca60613          	addi	a2,a2,458 # ffffffffc02027f8 <buddy_system_pmm_manager+0x98>
ffffffffc0201636:	08d00593          	li	a1,141
ffffffffc020163a:	00001517          	auipc	a0,0x1
ffffffffc020163e:	1e650513          	addi	a0,a0,486 # ffffffffc0202820 <buddy_system_pmm_manager+0xc0>
...
ffffffffc0201684:	24078793          	addi	a5,a5,576 # ffffffffc02028c0 <buddy_system_pmm_manager+0x160>
...
ffffffffc02016e0:	218a8a93          	addi	s5,s5,536 # ffffffffc02028f4 <buddy_system_pmm_manager+0x194>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02016e8:	3ecb8b93          	addi	s7,s7,1004 # ffffffffc0202ad0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
...
ffffffffc020193e:	fb660613          	addi	a2,a2,-74 # ffffffffc02028f0 <buddy_system_pmm_manager+0x190>
...
ffffffffc0201950:	f9460613          	addi	a2,a2,-108 # ffffffffc02028e0 <buddy_system_pmm_manager+0x180>
...
ffffffffc0201962:	f7a40413          	addi	s0,s0,-134 # ffffffffc02028d8 <buddy_system_pmm_manager+0x178>
...
ffffffffc02019ec:	ef040413          	addi	s0,s0,-272 # ffffffffc02028d8 <buddy_system_pmm_manager+0x178>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
ffffffffc0201a02:	edba0a13          	addi	s4,s4,-293 # ffffffffc02028d9 <buddy_system_pmm_manager+0x179>
...
ffffffffc0201a4e:	ea650513          	addi	a0,a0,-346 # ffffffffc02028f0 <buddy_system_pmm_manager+0x190>
