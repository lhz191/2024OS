...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	366040ef          	jal	ra,ffffffffc02043b0 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	39258593          	addi	a1,a1,914 # ffffffffc02043e0 <etext+0x6>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	3aa50513          	addi	a0,a0,938 # ffffffffc0204400 <etext+0x26>
...
ffffffffc020006e:	612030ef          	jal	ra,ffffffffc0203680 <vmm_init>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	651030ef          	jal	ra,ffffffffc0203efe <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	61b030ef          	jal	ra,ffffffffc0203efe <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	30450513          	addi	a0,a0,772 # ffffffffc0204408 <etext+0x2e>
void print_kerninfo(void) {
...
ffffffffc020011e:	30e50513          	addi	a0,a0,782 # ffffffffc0204428 <etext+0x4e>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2b458593          	addi	a1,a1,692 # ffffffffc02043da <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	31a50513          	addi	a0,a0,794 # ffffffffc0204448 <etext+0x6e>
...
ffffffffc0200146:	32650513          	addi	a0,a0,806 # ffffffffc0204468 <etext+0x8e>
...
ffffffffc020015a:	33250513          	addi	a0,a0,818 # ffffffffc0204488 <etext+0xae>
...
ffffffffc0200188:	32450513          	addi	a0,a0,804 # ffffffffc02044a8 <etext+0xce>
}
...
ffffffffc0200196:	34660613          	addi	a2,a2,838 # ffffffffc02044d8 <etext+0xfe>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	35250513          	addi	a0,a0,850 # ffffffffc02044f0 <etext+0x116>
void print_stackframe(void) {
...
ffffffffc02001b2:	35a60613          	addi	a2,a2,858 # ffffffffc0204508 <etext+0x12e>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	37258593          	addi	a1,a1,882 # ffffffffc0204528 <etext+0x14e>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	37250513          	addi	a0,a0,882 # ffffffffc0204530 <etext+0x156>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	37460613          	addi	a2,a2,884 # ffffffffc0204540 <etext+0x166>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	39458593          	addi	a1,a1,916 # ffffffffc0204568 <etext+0x18e>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	35450513          	addi	a0,a0,852 # ffffffffc0204530 <etext+0x156>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	39060613          	addi	a2,a2,912 # ffffffffc0204578 <etext+0x19e>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	3a858593          	addi	a1,a1,936 # ffffffffc0204598 <etext+0x1be>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	33850513          	addi	a0,a0,824 # ffffffffc0204530 <etext+0x156>
...
ffffffffc0200236:	37650513          	addi	a0,a0,886 # ffffffffc02045a8 <etext+0x1ce>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	37c50513          	addi	a0,a0,892 # ffffffffc02045d0 <etext+0x1f6>
...
ffffffffc020027e:	37e48493          	addi	s1,s1,894 # ffffffffc02045f8 <etext+0x21e>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	37cb0b13          	addi	s6,s6,892 # ffffffffc0204600 <etext+0x226>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	29ca0a13          	addi	s4,s4,668 # ffffffffc0204528 <etext+0x14e>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	7e9030ef          	jal	ra,ffffffffc0204280 <readline>
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0c0040ef          	jal	ra,ffffffffc020437c <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	0ac040ef          	jal	ra,ffffffffc020437c <strcmp>
...
ffffffffc020030e:	08c040ef          	jal	ra,ffffffffc020439a <strchr>
...
ffffffffc020034c:	04e040ef          	jal	ra,ffffffffc020439a <strchr>
...
ffffffffc020036a:	2ba50513          	addi	a0,a0,698 # ffffffffc0204620 <etext+0x246>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	70b030ef          	jal	ra,ffffffffc02043c2 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	6e7030ef          	jal	ra,ffffffffc02043c2 <memcpy>
    return 0;
}
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	7100306f          	j	ffffffffc0203c58 <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc0201760:	451020ef          	jal	ra,ffffffffc02043b0 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201802:	3af020ef          	jal	ra,ffffffffc02043b0 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201f60:	40a020ef          	jal	ra,ffffffffc020436a <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	410020ef          	jal	ra,ffffffffc020437c <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	38e020ef          	jal	ra,ffffffffc0204334 <strlen>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	3f0010ef          	jal	ra,ffffffffc0203d26 <swapfs_init>
...
ffffffffc02029ec:	2d9000ef          	jal	ra,ffffffffc02034c4 <mm_create>
...
ffffffffc0202a20:	2ed000ef          	jal	ra,ffffffffc020350c <vma_create>
...
ffffffffc0202a2c:	34f000ef          	jal	ra,ffffffffc020357a <insert_vma_struct>
...
ffffffffc0202c36:	215000ef          	jal	ra,ffffffffc020364a <mm_destroy>
...
ffffffffc0203040:	5b9000ef          	jal	ra,ffffffffc0203df8 <swapfs_write>
...
ffffffffc02030de:	481000ef          	jal	ra,ffffffffc0203d5e <swapfs_read>
...
ffffffffc02033b6:	e04a                	sd	s2,0(sp)
         assert(head != NULL);
ffffffffc02033b8:	c32d                	beqz	a4,ffffffffc020341a <_clock_swap_out_victim+0x6e>
     assert(in_tick==0);
ffffffffc02033ba:	e241                	bnez	a2,ffffffffc020343a <_clock_swap_out_victim+0x8e>
ffffffffc02033bc:	0000e497          	auipc	s1,0xe
ffffffffc02033c0:	19c48493          	addi	s1,s1,412 # ffffffffc0211558 <curr_ptr>
ffffffffc02033c4:	6080                	ld	s0,0(s1)
ffffffffc02033c6:	892e                	mv	s2,a1
ffffffffc02033c8:	4681                	li	a3,0
        if(curr_ptr == head) 
ffffffffc02033ca:	00870b63          	beq	a4,s0,ffffffffc02033e0 <_clock_swap_out_victim+0x34>
        if(page->visited == 0) {
ffffffffc02033ce:	fe043783          	ld	a5,-32(s0)
ffffffffc02033d2:	cb91                	beqz	a5,ffffffffc02033e6 <_clock_swap_out_victim+0x3a>
            page->visited = 0;
ffffffffc02033d4:	fe043023          	sd	zero,-32(s0)
    return listelm->next;
ffffffffc02033d8:	6400                	ld	s0,8(s0)
{
ffffffffc02033da:	4685                	li	a3,1
        if(curr_ptr == head) 
ffffffffc02033dc:	fe8719e3          	bne	a4,s0,ffffffffc02033ce <_clock_swap_out_victim+0x22>
ffffffffc02033e0:	6700                	ld	s0,8(a4)
{
ffffffffc02033e2:	4685                	li	a3,1
ffffffffc02033e4:	bfe5                	j	ffffffffc02033dc <_clock_swap_out_victim+0x30>
ffffffffc02033e6:	c291                	beqz	a3,ffffffffc02033ea <_clock_swap_out_victim+0x3e>
ffffffffc02033e8:	e080                	sd	s0,0(s1)
            cprintf("curr_ptr %p\n", curr_ptr);
ffffffffc02033ea:	85a2                	mv	a1,s0
ffffffffc02033ec:	00002517          	auipc	a0,0x2
ffffffffc02033f0:	7d450513          	addi	a0,a0,2004 # ffffffffc0205bc0 <default_pmm_manager+0xaa0>
...
ffffffffc0203400:	671c                	ld	a5,8(a4)
    __list_del(listelm->prev, listelm->next);
ffffffffc0203402:	6318                	ld	a4,0(a4)
ffffffffc0203404:	4501                	li	a0,0
    prev->next = next;
ffffffffc0203406:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203408:	e398                	sd	a4,0(a5)
            *ptr_page = page;
ffffffffc020340a:	00893023          	sd	s0,0(s2)
}
ffffffffc020340e:	6442                	ld	s0,16(sp)
            curr_ptr = next;  
ffffffffc0203410:	e09c                	sd	a5,0(s1)
}
ffffffffc0203412:	6902                	ld	s2,0(sp)
ffffffffc0203414:	64a2                	ld	s1,8(sp)
ffffffffc0203416:	6105                	addi	sp,sp,32
ffffffffc0203418:	8082                	ret
         assert(head != NULL);
ffffffffc020341a:	00002697          	auipc	a3,0x2
ffffffffc020341e:	78668693          	addi	a3,a3,1926 # ffffffffc0205ba0 <default_pmm_manager+0xa80>
ffffffffc0203422:	00002617          	auipc	a2,0x2
ffffffffc0203426:	94e60613          	addi	a2,a2,-1714 # ffffffffc0204d70 <commands+0x738>
ffffffffc020342a:	04900593          	li	a1,73
ffffffffc020342e:	00002517          	auipc	a0,0x2
ffffffffc0203432:	71250513          	addi	a0,a0,1810 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203436:	f3ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc020343a:	00002697          	auipc	a3,0x2
ffffffffc020343e:	77668693          	addi	a3,a3,1910 # ffffffffc0205bb0 <default_pmm_manager+0xa90>
ffffffffc0203442:	00002617          	auipc	a2,0x2
ffffffffc0203446:	92e60613          	addi	a2,a2,-1746 # ffffffffc0204d70 <commands+0x738>
ffffffffc020344a:	04a00593          	li	a1,74
ffffffffc020344e:	00002517          	auipc	a0,0x2
ffffffffc0203452:	6f250513          	addi	a0,a0,1778 # ffffffffc0205b40 <default_pmm_manager+0xa20>
ffffffffc0203456:	f1ffc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020345a <_clock_map_swappable>:
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc020345a:	0000e797          	auipc	a5,0xe
ffffffffc020345e:	0fe7b783          	ld	a5,254(a5) # ffffffffc0211558 <curr_ptr>
ffffffffc0203462:	cf89                	beqz	a5,ffffffffc020347c <_clock_map_swappable+0x22>
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203464:	751c                	ld	a5,40(a0)
ffffffffc0203466:	03060713          	addi	a4,a2,48
}
ffffffffc020346a:	4501                	li	a0,0
    __list_add(elm, listelm->prev, listelm);
ffffffffc020346c:	6394                	ld	a3,0(a5)
    prev->next = next->prev = elm;
ffffffffc020346e:	e398                	sd	a4,0(a5)
ffffffffc0203470:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc0203472:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc0203474:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc0203476:	fa14                	sd	a3,48(a2)
ffffffffc0203478:	ea1c                	sd	a5,16(a2)
}
ffffffffc020347a:	8082                	ret
{
ffffffffc020347c:	1141                	addi	sp,sp,-16
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc020347e:	00002697          	auipc	a3,0x2
ffffffffc0203482:	75268693          	addi	a3,a3,1874 # ffffffffc0205bd0 <default_pmm_manager+0xab0>
ffffffffc0203486:	00002617          	auipc	a2,0x2
ffffffffc020348a:	8ea60613          	addi	a2,a2,-1814 # ffffffffc0204d70 <commands+0x738>
ffffffffc020348e:	03600593          	li	a1,54
ffffffffc0203492:	00002517          	auipc	a0,0x2
ffffffffc0203496:	6ae50513          	addi	a0,a0,1710 # ffffffffc0205b40 <default_pmm_manager+0xa20>
{
ffffffffc020349a:	e406                	sd	ra,8(sp)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc020349c:	ed9fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034a0 <check_vma_overlap.part.0>:
}
...
ffffffffc02034a6:	76e68693          	addi	a3,a3,1902 # ffffffffc0205c10 <default_pmm_manager+0xaf0>
ffffffffc02034aa:	00002617          	auipc	a2,0x2
ffffffffc02034ae:	8c660613          	addi	a2,a2,-1850 # ffffffffc0204d70 <commands+0x738>
ffffffffc02034b2:	07d00593          	li	a1,125
ffffffffc02034b6:	00002517          	auipc	a0,0x2
ffffffffc02034ba:	77a50513          	addi	a0,a0,1914 # ffffffffc0205c30 <default_pmm_manager+0xb10>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02034be:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc02034c0:	eb5fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034c4 <mm_create>:
mm_create(void) {
...
ffffffffc02034cc:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02034ce:	aaaff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02034d2:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02034d4:	c105                	beqz	a0,ffffffffc02034f4 <mm_create+0x30>
    elm->prev = elm->next = elm;
ffffffffc02034d6:	e408                	sd	a0,8(s0)
ffffffffc02034d8:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02034da:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02034de:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02034e2:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02034e6:	0000e797          	auipc	a5,0xe
ffffffffc02034ea:	06a7a783          	lw	a5,106(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02034ee:	eb81                	bnez	a5,ffffffffc02034fe <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc02034f0:	02053423          	sd	zero,40(a0)
}
ffffffffc02034f4:	60a2                	ld	ra,8(sp)
ffffffffc02034f6:	8522                	mv	a0,s0
ffffffffc02034f8:	6402                	ld	s0,0(sp)
ffffffffc02034fa:	0141                	addi	sp,sp,16
ffffffffc02034fc:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02034fe:	a87ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
...
ffffffffc020350c <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020350c:	1101                	addi	sp,sp,-32
ffffffffc020350e:	e04a                	sd	s2,0(sp)
ffffffffc0203510:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203512:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203516:	e822                	sd	s0,16(sp)
ffffffffc0203518:	e426                	sd	s1,8(sp)
ffffffffc020351a:	ec06                	sd	ra,24(sp)
ffffffffc020351c:	84ae                	mv	s1,a1
ffffffffc020351e:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203520:	a58ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc0203524:	c509                	beqz	a0,ffffffffc020352e <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc0203526:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc020352a:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020352c:	ed00                	sd	s0,24(a0)
}
ffffffffc020352e:	60e2                	ld	ra,24(sp)
ffffffffc0203530:	6442                	ld	s0,16(sp)
ffffffffc0203532:	64a2                	ld	s1,8(sp)
ffffffffc0203534:	6902                	ld	s2,0(sp)
ffffffffc0203536:	6105                	addi	sp,sp,32
ffffffffc0203538:	8082                	ret

ffffffffc020353a <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc020353a:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc020353c:	c505                	beqz	a0,ffffffffc0203564 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc020353e:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203540:	c501                	beqz	a0,ffffffffc0203548 <find_vma+0xe>
ffffffffc0203542:	651c                	ld	a5,8(a0)
ffffffffc0203544:	02f5f263          	bgeu	a1,a5,ffffffffc0203568 <find_vma+0x2e>
    return listelm->next;
ffffffffc0203548:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc020354a:	00f68d63          	beq	a3,a5,ffffffffc0203564 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc020354e:	fe87b703          	ld	a4,-24(a5)
ffffffffc0203552:	00e5e663          	bltu	a1,a4,ffffffffc020355e <find_vma+0x24>
ffffffffc0203556:	ff07b703          	ld	a4,-16(a5)
ffffffffc020355a:	00e5ec63          	bltu	a1,a4,ffffffffc0203572 <find_vma+0x38>
ffffffffc020355e:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203560:	fef697e3          	bne	a3,a5,ffffffffc020354e <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc0203564:	4501                	li	a0,0
}
ffffffffc0203566:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203568:	691c                	ld	a5,16(a0)
ffffffffc020356a:	fcf5ffe3          	bgeu	a1,a5,ffffffffc0203548 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc020356e:	ea88                	sd	a0,16(a3)
ffffffffc0203570:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc0203572:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc0203576:	ea88                	sd	a0,16(a3)
ffffffffc0203578:	8082                	ret

ffffffffc020357a <insert_vma_struct>:
...
ffffffffc020357a:	6590                	ld	a2,8(a1)
ffffffffc020357c:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc0203580:	1141                	addi	sp,sp,-16
ffffffffc0203582:	e406                	sd	ra,8(sp)
ffffffffc0203584:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203586:	01066763          	bltu	a2,a6,ffffffffc0203594 <insert_vma_struct+0x1a>
ffffffffc020358a:	a085                	j	ffffffffc02035ea <insert_vma_struct+0x70>
...
ffffffffc0203590:	04e66863          	bltu	a2,a4,ffffffffc02035e0 <insert_vma_struct+0x66>
ffffffffc0203594:	86be                	mv	a3,a5
ffffffffc0203596:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0203598:	fef51ae3          	bne	a0,a5,ffffffffc020358c <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc020359c:	02a68463          	beq	a3,a0,ffffffffc02035c4 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02035a0:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035a4:	fe86b883          	ld	a7,-24(a3)
ffffffffc02035a8:	08e8f163          	bgeu	a7,a4,ffffffffc020362a <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035ac:	04e66f63          	bltu	a2,a4,ffffffffc020360a <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc02035b0:	00f50a63          	beq	a0,a5,ffffffffc02035c4 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc02035b4:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035b8:	05076963          	bltu	a4,a6,ffffffffc020360a <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc02035bc:	ff07b603          	ld	a2,-16(a5)
ffffffffc02035c0:	02c77363          	bgeu	a4,a2,ffffffffc02035e6 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc02035c4:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc02035c6:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02035c8:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02035cc:	e390                	sd	a2,0(a5)
ffffffffc02035ce:	e690                	sd	a2,8(a3)
}
ffffffffc02035d0:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02035d2:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02035d4:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc02035d6:	0017079b          	addiw	a5,a4,1
ffffffffc02035da:	d11c                	sw	a5,32(a0)
}
ffffffffc02035dc:	0141                	addi	sp,sp,16
ffffffffc02035de:	8082                	ret
    if (le_prev != list) {
ffffffffc02035e0:	fca690e3          	bne	a3,a0,ffffffffc02035a0 <insert_vma_struct+0x26>
ffffffffc02035e4:	bfd1                	j	ffffffffc02035b8 <insert_vma_struct+0x3e>
ffffffffc02035e6:	ebbff0ef          	jal	ra,ffffffffc02034a0 <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035ea:	00002697          	auipc	a3,0x2
ffffffffc02035ee:	65668693          	addi	a3,a3,1622 # ffffffffc0205c40 <default_pmm_manager+0xb20>
ffffffffc02035f2:	00001617          	auipc	a2,0x1
ffffffffc02035f6:	77e60613          	addi	a2,a2,1918 # ffffffffc0204d70 <commands+0x738>
ffffffffc02035fa:	08400593          	li	a1,132
ffffffffc02035fe:	00002517          	auipc	a0,0x2
ffffffffc0203602:	63250513          	addi	a0,a0,1586 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203606:	d6ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020360a:	00002697          	auipc	a3,0x2
ffffffffc020360e:	67668693          	addi	a3,a3,1654 # ffffffffc0205c80 <default_pmm_manager+0xb60>
ffffffffc0203612:	00001617          	auipc	a2,0x1
ffffffffc0203616:	75e60613          	addi	a2,a2,1886 # ffffffffc0204d70 <commands+0x738>
ffffffffc020361a:	07c00593          	li	a1,124
ffffffffc020361e:	00002517          	auipc	a0,0x2
ffffffffc0203622:	61250513          	addi	a0,a0,1554 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203626:	d4ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020362a:	00002697          	auipc	a3,0x2
ffffffffc020362e:	63668693          	addi	a3,a3,1590 # ffffffffc0205c60 <default_pmm_manager+0xb40>
ffffffffc0203632:	00001617          	auipc	a2,0x1
ffffffffc0203636:	73e60613          	addi	a2,a2,1854 # ffffffffc0204d70 <commands+0x738>
ffffffffc020363a:	07b00593          	li	a1,123
ffffffffc020363e:	00002517          	auipc	a0,0x2
ffffffffc0203642:	5f250513          	addi	a0,a0,1522 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203646:	d2ffc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020364a <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc020364a:	1141                	addi	sp,sp,-16
ffffffffc020364c:	e022                	sd	s0,0(sp)
ffffffffc020364e:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203650:	6508                	ld	a0,8(a0)
ffffffffc0203652:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203654:	00a40e63          	beq	s0,a0,ffffffffc0203670 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203658:	6118                	ld	a4,0(a0)
ffffffffc020365a:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020365c:	03000593          	li	a1,48
ffffffffc0203660:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203662:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203664:	e398                	sd	a4,0(a5)
ffffffffc0203666:	9ccff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020366a:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020366c:	fea416e3          	bne	s0,a0,ffffffffc0203658 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203670:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc0203672:	6402                	ld	s0,0(sp)
ffffffffc0203674:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203676:	03000593          	li	a1,48
}
ffffffffc020367a:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020367c:	9b6ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc0203680 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc0203680:	715d                	addi	sp,sp,-80
ffffffffc0203682:	e486                	sd	ra,72(sp)
ffffffffc0203684:	f44e                	sd	s3,40(sp)
ffffffffc0203686:	f052                	sd	s4,32(sp)
ffffffffc0203688:	e0a2                	sd	s0,64(sp)
ffffffffc020368a:	fc26                	sd	s1,56(sp)
ffffffffc020368c:	f84a                	sd	s2,48(sp)
ffffffffc020368e:	ec56                	sd	s5,24(sp)
ffffffffc0203690:	e85a                	sd	s6,16(sp)
ffffffffc0203692:	e45e                	sd	s7,8(sp)
}
...
ffffffffc0203694:	ffffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203698:	89aa                	mv	s3,a0
...
ffffffffc020369e:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02036a0:	03000513          	li	a0,48
ffffffffc02036a4:	8d4ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc02036a8:	56050863          	beqz	a0,ffffffffc0203c18 <vmm_init+0x598>
    elm->prev = elm->next = elm;
ffffffffc02036ac:	e508                	sd	a0,8(a0)
ffffffffc02036ae:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02036b0:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02036b4:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02036b8:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02036bc:	0000e797          	auipc	a5,0xe
ffffffffc02036c0:	e947a783          	lw	a5,-364(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc02036c4:	84aa                	mv	s1,a0
ffffffffc02036c6:	e7b9                	bnez	a5,ffffffffc0203714 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc02036c8:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc02036cc:	03200413          	li	s0,50
ffffffffc02036d0:	a811                	j	ffffffffc02036e4 <vmm_init+0x64>
        vma->vm_start = vm_start;
ffffffffc02036d2:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc02036d4:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02036d6:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc02036da:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02036dc:	8526                	mv	a0,s1
ffffffffc02036de:	e9dff0ef          	jal	ra,ffffffffc020357a <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02036e2:	cc05                	beqz	s0,ffffffffc020371a <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02036e4:	03000513          	li	a0,48
ffffffffc02036e8:	890ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02036ec:	85aa                	mv	a1,a0
ffffffffc02036ee:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc02036f2:	f165                	bnez	a0,ffffffffc02036d2 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc02036f4:	00002697          	auipc	a3,0x2
ffffffffc02036f8:	15c68693          	addi	a3,a3,348 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc02036fc:	00001617          	auipc	a2,0x1
ffffffffc0203700:	67460613          	addi	a2,a2,1652 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203704:	0ce00593          	li	a1,206
ffffffffc0203708:	00002517          	auipc	a0,0x2
ffffffffc020370c:	52850513          	addi	a0,a0,1320 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203710:	c65fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203714:	871ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203718:	bf55                	j	ffffffffc02036cc <vmm_init+0x4c>
ffffffffc020371a:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020371e:	1f900913          	li	s2,505
ffffffffc0203722:	a819                	j	ffffffffc0203738 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc0203724:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203726:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203728:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020372c:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020372e:	8526                	mv	a0,s1
ffffffffc0203730:	e4bff0ef          	jal	ra,ffffffffc020357a <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203734:	03240a63          	beq	s0,s2,ffffffffc0203768 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203738:	03000513          	li	a0,48
ffffffffc020373c:	83cff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203740:	85aa                	mv	a1,a0
ffffffffc0203742:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203746:	fd79                	bnez	a0,ffffffffc0203724 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc0203748:	00002697          	auipc	a3,0x2
ffffffffc020374c:	10868693          	addi	a3,a3,264 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc0203750:	00001617          	auipc	a2,0x1
ffffffffc0203754:	62060613          	addi	a2,a2,1568 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203758:	0d400593          	li	a1,212
ffffffffc020375c:	00002517          	auipc	a0,0x2
ffffffffc0203760:	4d450513          	addi	a0,a0,1236 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203764:	c11fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc0203768:	649c                	ld	a5,8(s1)
ffffffffc020376a:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc020376c:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc0203770:	2ef48463          	beq	s1,a5,ffffffffc0203a58 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203774:	fe87b603          	ld	a2,-24(a5)
ffffffffc0203778:	ffe70693          	addi	a3,a4,-2
ffffffffc020377c:	26d61e63          	bne	a2,a3,ffffffffc02039f8 <vmm_init+0x378>
ffffffffc0203780:	ff07b683          	ld	a3,-16(a5)
ffffffffc0203784:	26e69a63          	bne	a3,a4,ffffffffc02039f8 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc0203788:	0715                	addi	a4,a4,5
ffffffffc020378a:	679c                	ld	a5,8(a5)
ffffffffc020378c:	feb712e3          	bne	a4,a1,ffffffffc0203770 <vmm_init+0xf0>
ffffffffc0203790:	4b1d                	li	s6,7
ffffffffc0203792:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc0203794:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203798:	85a2                	mv	a1,s0
ffffffffc020379a:	8526                	mv	a0,s1
ffffffffc020379c:	d9fff0ef          	jal	ra,ffffffffc020353a <find_vma>
ffffffffc02037a0:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc02037a2:	2c050b63          	beqz	a0,ffffffffc0203a78 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02037a6:	00140593          	addi	a1,s0,1
ffffffffc02037aa:	8526                	mv	a0,s1
ffffffffc02037ac:	d8fff0ef          	jal	ra,ffffffffc020353a <find_vma>
ffffffffc02037b0:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc02037b2:	2e050363          	beqz	a0,ffffffffc0203a98 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02037b6:	85da                	mv	a1,s6
ffffffffc02037b8:	8526                	mv	a0,s1
ffffffffc02037ba:	d81ff0ef          	jal	ra,ffffffffc020353a <find_vma>
        assert(vma3 == NULL);
ffffffffc02037be:	2e051d63          	bnez	a0,ffffffffc0203ab8 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02037c2:	00340593          	addi	a1,s0,3
ffffffffc02037c6:	8526                	mv	a0,s1
ffffffffc02037c8:	d73ff0ef          	jal	ra,ffffffffc020353a <find_vma>
        assert(vma4 == NULL);
ffffffffc02037cc:	30051663          	bnez	a0,ffffffffc0203ad8 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02037d0:	00440593          	addi	a1,s0,4
ffffffffc02037d4:	8526                	mv	a0,s1
ffffffffc02037d6:	d65ff0ef          	jal	ra,ffffffffc020353a <find_vma>
        assert(vma5 == NULL);
ffffffffc02037da:	30051f63          	bnez	a0,ffffffffc0203af8 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02037de:	00893783          	ld	a5,8(s2)
ffffffffc02037e2:	24879b63          	bne	a5,s0,ffffffffc0203a38 <vmm_init+0x3b8>
ffffffffc02037e6:	01093783          	ld	a5,16(s2)
ffffffffc02037ea:	25679763          	bne	a5,s6,ffffffffc0203a38 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02037ee:	008ab783          	ld	a5,8(s5)
ffffffffc02037f2:	22879363          	bne	a5,s0,ffffffffc0203a18 <vmm_init+0x398>
ffffffffc02037f6:	010ab783          	ld	a5,16(s5)
ffffffffc02037fa:	21679f63          	bne	a5,s6,ffffffffc0203a18 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02037fe:	0415                	addi	s0,s0,5
ffffffffc0203800:	0b15                	addi	s6,s6,5
ffffffffc0203802:	f9741be3          	bne	s0,s7,ffffffffc0203798 <vmm_init+0x118>
ffffffffc0203806:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc0203808:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc020380a:	85a2                	mv	a1,s0
ffffffffc020380c:	8526                	mv	a0,s1
ffffffffc020380e:	d2dff0ef          	jal	ra,ffffffffc020353a <find_vma>
ffffffffc0203812:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203816:	c90d                	beqz	a0,ffffffffc0203848 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203818:	6914                	ld	a3,16(a0)
ffffffffc020381a:	6510                	ld	a2,8(a0)
ffffffffc020381c:	00002517          	auipc	a0,0x2
ffffffffc0203820:	58450513          	addi	a0,a0,1412 # ffffffffc0205da0 <default_pmm_manager+0xc80>
ffffffffc0203824:	897fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203828:	00002697          	auipc	a3,0x2
ffffffffc020382c:	5a068693          	addi	a3,a3,1440 # ffffffffc0205dc8 <default_pmm_manager+0xca8>
ffffffffc0203830:	00001617          	auipc	a2,0x1
ffffffffc0203834:	54060613          	addi	a2,a2,1344 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203838:	0f600593          	li	a1,246
ffffffffc020383c:	00002517          	auipc	a0,0x2
ffffffffc0203840:	3f450513          	addi	a0,a0,1012 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203844:	b31fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc0203848:	147d                	addi	s0,s0,-1
ffffffffc020384a:	fd2410e3          	bne	s0,s2,ffffffffc020380a <vmm_init+0x18a>
ffffffffc020384e:	a811                	j	ffffffffc0203862 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203850:	6118                	ld	a4,0(a0)
ffffffffc0203852:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203854:	03000593          	li	a1,48
ffffffffc0203858:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc020385a:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc020385c:	e398                	sd	a4,0(a5)
ffffffffc020385e:	fd5fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc0203862:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc0203864:	fea496e3          	bne	s1,a0,ffffffffc0203850 <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203868:	03000593          	li	a1,48
ffffffffc020386c:	8526                	mv	a0,s1
...
ffffffffc0203872:	e21fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203876:	3caa1163          	bne	s4,a0,ffffffffc0203c38 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc020387a:	00002517          	auipc	a0,0x2
ffffffffc020387e:	58e50513          	addi	a0,a0,1422 # ffffffffc0205e08 <default_pmm_manager+0xce8>
ffffffffc0203882:	839fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203886:	e0dfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc020388a:	84aa                	mv	s1,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc020388c:	03000513          	li	a0,48
ffffffffc0203890:	ee9fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc0203894:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203896:	2a050163          	beqz	a0,ffffffffc0203b38 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020389a:	0000e797          	auipc	a5,0xe
ffffffffc020389e:	cb67a783          	lw	a5,-842(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc02038a2:	e508                	sd	a0,8(a0)
ffffffffc02038a4:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
...
ffffffffc02038ae:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038b2:	14079063          	bnez	a5,ffffffffc02039f2 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc02038b6:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038ba:	0000e917          	auipc	s2,0xe
ffffffffc02038be:	c5e93903          	ld	s2,-930(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc02038c2:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc02038c6:	0000e717          	auipc	a4,0xe
ffffffffc02038ca:	c8873d23          	sd	s0,-870(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc02038ce:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc02038d2:	24079363          	bnez	a5,ffffffffc0203b18 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02038d6:	03000513          	li	a0,48
ffffffffc02038da:	e9ffe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02038de:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc02038e0:	28050063          	beqz	a0,ffffffffc0203b60 <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc02038e4:	002007b7          	lui	a5,0x200
ffffffffc02038e8:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc02038ec:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc02038ee:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc02038f0:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038f4:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc02038f6:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02038fa:	c81ff0ef          	jal	ra,ffffffffc020357a <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02038fe:	10000593          	li	a1,256
ffffffffc0203902:	8522                	mv	a0,s0
ffffffffc0203904:	c37ff0ef          	jal	ra,ffffffffc020353a <find_vma>
ffffffffc0203908:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc020390c:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc0203910:	26aa1863          	bne	s4,a0,ffffffffc0203b80 <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc0203914:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203918:	0785                	addi	a5,a5,1
ffffffffc020391a:	fee79de3          	bne	a5,a4,ffffffffc0203914 <vmm_init+0x294>
        sum += i;
ffffffffc020391e:	6705                	lui	a4,0x1
ffffffffc0203920:	10000793          	li	a5,256
ffffffffc0203924:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc0203928:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc020392c:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc0203930:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203932:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203934:	fec79ce3          	bne	a5,a2,ffffffffc020392c <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc0203938:	26071463          	bnez	a4,ffffffffc0203ba0 <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc020393c:	4581                	li	a1,0
ffffffffc020393e:	854a                	mv	a0,s2
ffffffffc0203940:	fddfd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203944:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203948:	0000e717          	auipc	a4,0xe
ffffffffc020394c:	bd873703          	ld	a4,-1064(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203950:	078a                	slli	a5,a5,0x2
ffffffffc0203952:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc0203954:	26e7f663          	bgeu	a5,a4,ffffffffc0203bc0 <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc0203958:	00003717          	auipc	a4,0x3
ffffffffc020395c:	87873703          	ld	a4,-1928(a4) # ffffffffc02061d0 <nbase>
ffffffffc0203960:	8f99                	sub	a5,a5,a4
ffffffffc0203962:	00379713          	slli	a4,a5,0x3
ffffffffc0203966:	97ba                	add	a5,a5,a4
ffffffffc0203968:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc020396a:	0000e517          	auipc	a0,0xe
ffffffffc020396e:	bbe53503          	ld	a0,-1090(a0) # ffffffffc0211528 <pages>
ffffffffc0203972:	953e                	add	a0,a0,a5
ffffffffc0203974:	4585                	li	a1,1
ffffffffc0203976:	cddfd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc020397a:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc020397c:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc0203980:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203984:	00a40e63          	beq	s0,a0,ffffffffc02039a0 <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc0203988:	6118                	ld	a4,0(a0)
ffffffffc020398a:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc020398c:	03000593          	li	a1,48
ffffffffc0203990:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203992:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203994:	e398                	sd	a4,0(a5)
ffffffffc0203996:	e9dfe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc020399a:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc020399c:	fea416e3          	bne	s0,a0,ffffffffc0203988 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02039a0:	03000593          	li	a1,48
...
ffffffffc02039aa:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc02039ac:	0000e797          	auipc	a5,0xe
ffffffffc02039b0:	ba07ba23          	sd	zero,-1100(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039b4:	cdffd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02039b8:	22a49063          	bne	s1,a0,ffffffffc0203bd8 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc02039bc:	00002517          	auipc	a0,0x2
ffffffffc02039c0:	49c50513          	addi	a0,a0,1180 # ffffffffc0205e58 <default_pmm_manager+0xd38>
ffffffffc02039c4:	ef6fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039c8:	ccbfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc02039cc:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039ce:	22a99563          	bne	s3,a0,ffffffffc0203bf8 <vmm_init+0x578>
}
ffffffffc02039d2:	6406                	ld	s0,64(sp)
ffffffffc02039d4:	60a6                	ld	ra,72(sp)
ffffffffc02039d6:	74e2                	ld	s1,56(sp)
ffffffffc02039d8:	7942                	ld	s2,48(sp)
ffffffffc02039da:	79a2                	ld	s3,40(sp)
ffffffffc02039dc:	7a02                	ld	s4,32(sp)
ffffffffc02039de:	6ae2                	ld	s5,24(sp)
ffffffffc02039e0:	6b42                	ld	s6,16(sp)
ffffffffc02039e2:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039e4:	00002517          	auipc	a0,0x2
ffffffffc02039e8:	49450513          	addi	a0,a0,1172 # ffffffffc0205e78 <default_pmm_manager+0xd58>
}
ffffffffc02039ec:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc02039ee:	eccfc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02039f2:	d92ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc02039f6:	b5d1                	j	ffffffffc02038ba <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02039f8:	00002697          	auipc	a3,0x2
ffffffffc02039fc:	2c068693          	addi	a3,a3,704 # ffffffffc0205cb8 <default_pmm_manager+0xb98>
ffffffffc0203a00:	00001617          	auipc	a2,0x1
ffffffffc0203a04:	37060613          	addi	a2,a2,880 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a08:	0dd00593          	li	a1,221
ffffffffc0203a0c:	00002517          	auipc	a0,0x2
ffffffffc0203a10:	22450513          	addi	a0,a0,548 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a14:	961fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a18:	00002697          	auipc	a3,0x2
ffffffffc0203a1c:	35868693          	addi	a3,a3,856 # ffffffffc0205d70 <default_pmm_manager+0xc50>
ffffffffc0203a20:	00001617          	auipc	a2,0x1
ffffffffc0203a24:	35060613          	addi	a2,a2,848 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a28:	0ee00593          	li	a1,238
ffffffffc0203a2c:	00002517          	auipc	a0,0x2
ffffffffc0203a30:	20450513          	addi	a0,a0,516 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a34:	941fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a38:	00002697          	auipc	a3,0x2
ffffffffc0203a3c:	30868693          	addi	a3,a3,776 # ffffffffc0205d40 <default_pmm_manager+0xc20>
ffffffffc0203a40:	00001617          	auipc	a2,0x1
ffffffffc0203a44:	33060613          	addi	a2,a2,816 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a48:	0ed00593          	li	a1,237
ffffffffc0203a4c:	00002517          	auipc	a0,0x2
ffffffffc0203a50:	1e450513          	addi	a0,a0,484 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a54:	921fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a58:	00002697          	auipc	a3,0x2
ffffffffc0203a5c:	24868693          	addi	a3,a3,584 # ffffffffc0205ca0 <default_pmm_manager+0xb80>
ffffffffc0203a60:	00001617          	auipc	a2,0x1
ffffffffc0203a64:	31060613          	addi	a2,a2,784 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a68:	0db00593          	li	a1,219
ffffffffc0203a6c:	00002517          	auipc	a0,0x2
ffffffffc0203a70:	1c450513          	addi	a0,a0,452 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a74:	901fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a78:	00002697          	auipc	a3,0x2
ffffffffc0203a7c:	27868693          	addi	a3,a3,632 # ffffffffc0205cf0 <default_pmm_manager+0xbd0>
ffffffffc0203a80:	00001617          	auipc	a2,0x1
ffffffffc0203a84:	2f060613          	addi	a2,a2,752 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203a88:	0e300593          	li	a1,227
ffffffffc0203a8c:	00002517          	auipc	a0,0x2
ffffffffc0203a90:	1a450513          	addi	a0,a0,420 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203a94:	8e1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a98:	00002697          	auipc	a3,0x2
ffffffffc0203a9c:	26868693          	addi	a3,a3,616 # ffffffffc0205d00 <default_pmm_manager+0xbe0>
ffffffffc0203aa0:	00001617          	auipc	a2,0x1
ffffffffc0203aa4:	2d060613          	addi	a2,a2,720 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203aa8:	0e500593          	li	a1,229
ffffffffc0203aac:	00002517          	auipc	a0,0x2
ffffffffc0203ab0:	18450513          	addi	a0,a0,388 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203ab4:	8c1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ab8:	00002697          	auipc	a3,0x2
ffffffffc0203abc:	25868693          	addi	a3,a3,600 # ffffffffc0205d10 <default_pmm_manager+0xbf0>
ffffffffc0203ac0:	00001617          	auipc	a2,0x1
ffffffffc0203ac4:	2b060613          	addi	a2,a2,688 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203ac8:	0e700593          	li	a1,231
ffffffffc0203acc:	00002517          	auipc	a0,0x2
ffffffffc0203ad0:	16450513          	addi	a0,a0,356 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203ad4:	8a1fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ad8:	00002697          	auipc	a3,0x2
ffffffffc0203adc:	24868693          	addi	a3,a3,584 # ffffffffc0205d20 <default_pmm_manager+0xc00>
ffffffffc0203ae0:	00001617          	auipc	a2,0x1
ffffffffc0203ae4:	29060613          	addi	a2,a2,656 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203ae8:	0e900593          	li	a1,233
ffffffffc0203aec:	00002517          	auipc	a0,0x2
ffffffffc0203af0:	14450513          	addi	a0,a0,324 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203af4:	881fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203af8:	00002697          	auipc	a3,0x2
ffffffffc0203afc:	23868693          	addi	a3,a3,568 # ffffffffc0205d30 <default_pmm_manager+0xc10>
ffffffffc0203b00:	00001617          	auipc	a2,0x1
ffffffffc0203b04:	27060613          	addi	a2,a2,624 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b08:	0eb00593          	li	a1,235
ffffffffc0203b0c:	00002517          	auipc	a0,0x2
ffffffffc0203b10:	12450513          	addi	a0,a0,292 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203b14:	861fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b18:	00002697          	auipc	a3,0x2
ffffffffc0203b1c:	d2868693          	addi	a3,a3,-728 # ffffffffc0205840 <default_pmm_manager+0x720>
ffffffffc0203b20:	00001617          	auipc	a2,0x1
ffffffffc0203b24:	25060613          	addi	a2,a2,592 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b28:	10d00593          	li	a1,269
ffffffffc0203b2c:	00002517          	auipc	a0,0x2
ffffffffc0203b30:	10450513          	addi	a0,a0,260 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203b34:	841fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b38:	00002697          	auipc	a3,0x2
ffffffffc0203b3c:	35868693          	addi	a3,a3,856 # ffffffffc0205e90 <default_pmm_manager+0xd70>
ffffffffc0203b40:	00001617          	auipc	a2,0x1
ffffffffc0203b44:	23060613          	addi	a2,a2,560 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b48:	10a00593          	li	a1,266
ffffffffc0203b4c:	00002517          	auipc	a0,0x2
ffffffffc0203b50:	0e450513          	addi	a0,a0,228 # ffffffffc0205c30 <default_pmm_manager+0xb10>
    check_mm_struct = mm_create();
ffffffffc0203b54:	0000e797          	auipc	a5,0xe
ffffffffc0203b58:	a007b623          	sd	zero,-1524(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203b5c:	819fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203b60:	00002697          	auipc	a3,0x2
ffffffffc0203b64:	cf068693          	addi	a3,a3,-784 # ffffffffc0205850 <default_pmm_manager+0x730>
ffffffffc0203b68:	00001617          	auipc	a2,0x1
ffffffffc0203b6c:	20860613          	addi	a2,a2,520 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b70:	11100593          	li	a1,273
ffffffffc0203b74:	00002517          	auipc	a0,0x2
ffffffffc0203b78:	0bc50513          	addi	a0,a0,188 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203b7c:	ff8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b80:	00002697          	auipc	a3,0x2
ffffffffc0203b84:	2a868693          	addi	a3,a3,680 # ffffffffc0205e28 <default_pmm_manager+0xd08>
ffffffffc0203b88:	00001617          	auipc	a2,0x1
ffffffffc0203b8c:	1e860613          	addi	a2,a2,488 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203b90:	11600593          	li	a1,278
ffffffffc0203b94:	00002517          	auipc	a0,0x2
ffffffffc0203b98:	09c50513          	addi	a0,a0,156 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203b9c:	fd8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203ba0:	00002697          	auipc	a3,0x2
ffffffffc0203ba4:	2a868693          	addi	a3,a3,680 # ffffffffc0205e48 <default_pmm_manager+0xd28>
ffffffffc0203ba8:	00001617          	auipc	a2,0x1
ffffffffc0203bac:	1c860613          	addi	a2,a2,456 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203bb0:	12000593          	li	a1,288
ffffffffc0203bb4:	00002517          	auipc	a0,0x2
ffffffffc0203bb8:	07c50513          	addi	a0,a0,124 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203bbc:	fb8fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203bc0:	00001617          	auipc	a2,0x1
ffffffffc0203bc4:	59860613          	addi	a2,a2,1432 # ffffffffc0205158 <default_pmm_manager+0x38>
ffffffffc0203bc8:	06500593          	li	a1,101
ffffffffc0203bcc:	00001517          	auipc	a0,0x1
ffffffffc0203bd0:	5ac50513          	addi	a0,a0,1452 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0203bd4:	fa0fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bd8:	00002697          	auipc	a3,0x2
ffffffffc0203bdc:	20868693          	addi	a3,a3,520 # ffffffffc0205de0 <default_pmm_manager+0xcc0>
ffffffffc0203be0:	00001617          	auipc	a2,0x1
ffffffffc0203be4:	19060613          	addi	a2,a2,400 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203be8:	12e00593          	li	a1,302
ffffffffc0203bec:	00002517          	auipc	a0,0x2
ffffffffc0203bf0:	04450513          	addi	a0,a0,68 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203bf4:	f80fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bf8:	00002697          	auipc	a3,0x2
ffffffffc0203bfc:	1e868693          	addi	a3,a3,488 # ffffffffc0205de0 <default_pmm_manager+0xcc0>
ffffffffc0203c00:	00001617          	auipc	a2,0x1
ffffffffc0203c04:	17060613          	addi	a2,a2,368 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203c08:	0bd00593          	li	a1,189
ffffffffc0203c0c:	00002517          	auipc	a0,0x2
ffffffffc0203c10:	02450513          	addi	a0,a0,36 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203c14:	f60fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c18:	00002697          	auipc	a3,0x2
ffffffffc0203c1c:	c0068693          	addi	a3,a3,-1024 # ffffffffc0205818 <default_pmm_manager+0x6f8>
ffffffffc0203c20:	00001617          	auipc	a2,0x1
ffffffffc0203c24:	15060613          	addi	a2,a2,336 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203c28:	0c700593          	li	a1,199
ffffffffc0203c2c:	00002517          	auipc	a0,0x2
ffffffffc0203c30:	00450513          	addi	a0,a0,4 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203c34:	f40fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c38:	00002697          	auipc	a3,0x2
ffffffffc0203c3c:	1a868693          	addi	a3,a3,424 # ffffffffc0205de0 <default_pmm_manager+0xcc0>
ffffffffc0203c40:	00001617          	auipc	a2,0x1
ffffffffc0203c44:	13060613          	addi	a2,a2,304 # ffffffffc0204d70 <commands+0x738>
ffffffffc0203c48:	0fb00593          	li	a1,251
ffffffffc0203c4c:	00002517          	auipc	a0,0x2
ffffffffc0203c50:	fe450513          	addi	a0,a0,-28 # ffffffffc0205c30 <default_pmm_manager+0xb10>
ffffffffc0203c54:	f20fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203c58 <do_pgfault>:
...
ffffffffc0203c58:	7179                	addi	sp,sp,-48
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c5a:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203c5c:	f022                	sd	s0,32(sp)
ffffffffc0203c5e:	ec26                	sd	s1,24(sp)
ffffffffc0203c60:	f406                	sd	ra,40(sp)
ffffffffc0203c62:	e84a                	sd	s2,16(sp)
ffffffffc0203c64:	8432                	mv	s0,a2
ffffffffc0203c66:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c68:	8d3ff0ef          	jal	ra,ffffffffc020353a <find_vma>

    pgfault_num++;
ffffffffc0203c6c:	0000e797          	auipc	a5,0xe
ffffffffc0203c70:	8fc7a783          	lw	a5,-1796(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203c74:	2785                	addiw	a5,a5,1
ffffffffc0203c76:	0000e717          	auipc	a4,0xe
ffffffffc0203c7a:	8ef72923          	sw	a5,-1806(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203c7e:	c159                	beqz	a0,ffffffffc0203d04 <do_pgfault+0xac>
ffffffffc0203c80:	651c                	ld	a5,8(a0)
ffffffffc0203c82:	08f46163          	bltu	s0,a5,ffffffffc0203d04 <do_pgfault+0xac>
...
ffffffffc0203c86:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c88:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c8a:	8b89                	andi	a5,a5,2
ffffffffc0203c8c:	ebb1                	bnez	a5,ffffffffc0203ce0 <do_pgfault+0x88>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c8e:	75fd                	lui	a1,0xfffff
...
ffffffffc0203c90:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203c92:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203c94:	85a2                	mv	a1,s0
ffffffffc0203c96:	4605                	li	a2,1
ffffffffc0203c98:	a35fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203c9c:	610c                	ld	a1,0(a0)
ffffffffc0203c9e:	c1b9                	beqz	a1,ffffffffc0203ce4 <do_pgfault+0x8c>
...
ffffffffc0203ca4:	8b07a783          	lw	a5,-1872(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203ca8:	c7bd                	beqz	a5,ffffffffc0203d16 <do_pgfault+0xbe>
...
ffffffffc0203caa:	85a2                	mv	a1,s0
ffffffffc0203cac:	0030                	addi	a2,sp,8
ffffffffc0203cae:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203cb0:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page);
ffffffffc0203cb2:	bfeff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
            page_insert(mm->pgdir, page, addr, perm);
ffffffffc0203cb6:	65a2                	ld	a1,8(sp)
ffffffffc0203cb8:	6c88                	ld	a0,24(s1)
ffffffffc0203cba:	86ca                	mv	a3,s2
ffffffffc0203cbc:	8622                	mv	a2,s0
ffffffffc0203cbe:	cf9fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm, addr, page, 1);
ffffffffc0203cc2:	6622                	ld	a2,8(sp)
ffffffffc0203cc4:	4685                	li	a3,1
ffffffffc0203cc6:	85a2                	mv	a1,s0
ffffffffc0203cc8:	8526                	mv	a0,s1
ffffffffc0203cca:	ac6ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203cce:	67a2                	ld	a5,8(sp)
...
ffffffffc0203cd0:	4501                	li	a0,0
            page->pra_vaddr = addr;
ffffffffc0203cd2:	e3a0                	sd	s0,64(a5)
failed:
    return ret;
}
...
ffffffffc0203cdc:	6145                	addi	sp,sp,48
ffffffffc0203cde:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203ce0:	4959                	li	s2,22
ffffffffc0203ce2:	b775                	j	ffffffffc0203c8e <do_pgfault+0x36>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203ce4:	6c88                	ld	a0,24(s1)
ffffffffc0203ce6:	864a                	mv	a2,s2
ffffffffc0203ce8:	85a2                	mv	a1,s0
ffffffffc0203cea:	9d7fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
ffffffffc0203cee:	87aa                	mv	a5,a0
   ret = 0;
ffffffffc0203cf0:	4501                	li	a0,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203cf2:	f3ed                	bnez	a5,ffffffffc0203cd4 <do_pgfault+0x7c>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203cf4:	00002517          	auipc	a0,0x2
ffffffffc0203cf8:	1e450513          	addi	a0,a0,484 # ffffffffc0205ed8 <default_pmm_manager+0xdb8>
ffffffffc0203cfc:	bbefc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d00:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d02:	bfc9                	j	ffffffffc0203cd4 <do_pgfault+0x7c>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d04:	85a2                	mv	a1,s0
ffffffffc0203d06:	00002517          	auipc	a0,0x2
ffffffffc0203d0a:	1a250513          	addi	a0,a0,418 # ffffffffc0205ea8 <default_pmm_manager+0xd88>
ffffffffc0203d0e:	bacfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d12:	5575                	li	a0,-3
        goto failed;
ffffffffc0203d14:	b7c1                	j	ffffffffc0203cd4 <do_pgfault+0x7c>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d16:	00002517          	auipc	a0,0x2
ffffffffc0203d1a:	1ea50513          	addi	a0,a0,490 # ffffffffc0205f00 <default_pmm_manager+0xde0>
ffffffffc0203d1e:	b9cfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d22:	5571                	li	a0,-4
            goto failed;
ffffffffc0203d24:	bf45                	j	ffffffffc0203cd4 <do_pgfault+0x7c>

ffffffffc0203d26 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203d2a:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d2c:	f68fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d30:	cd01                	beqz	a0,ffffffffc0203d48 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d32:	4505                	li	a0,1
ffffffffc0203d34:	f66fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203d38:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d3a:	810d                	srli	a0,a0,0x3
ffffffffc0203d3c:	0000e797          	auipc	a5,0xe
ffffffffc0203d40:	80a7b223          	sd	a0,-2044(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203d44:	0141                	addi	sp,sp,16
ffffffffc0203d46:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203d48:	00002617          	auipc	a2,0x2
ffffffffc0203d4c:	1e060613          	addi	a2,a2,480 # ffffffffc0205f28 <default_pmm_manager+0xe08>
ffffffffc0203d50:	45b5                	li	a1,13
ffffffffc0203d52:	00002517          	auipc	a0,0x2
ffffffffc0203d56:	1f650513          	addi	a0,a0,502 # ffffffffc0205f48 <default_pmm_manager+0xe28>
ffffffffc0203d5a:	e1afc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d5e <swapfs_read>:
...
ffffffffc0203d62:	00855793          	srli	a5,a0,0x8
ffffffffc0203d66:	c3a5                	beqz	a5,ffffffffc0203dc6 <swapfs_read+0x68>
ffffffffc0203d68:	0000d717          	auipc	a4,0xd
ffffffffc0203d6c:	7d873703          	ld	a4,2008(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203d70:	04e7fb63          	bgeu	a5,a4,ffffffffc0203dc6 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d74:	0000d617          	auipc	a2,0xd
ffffffffc0203d78:	7b463603          	ld	a2,1972(a2) # ffffffffc0211528 <pages>
ffffffffc0203d7c:	8d91                	sub	a1,a1,a2
ffffffffc0203d7e:	4035d613          	srai	a2,a1,0x3
ffffffffc0203d82:	00002597          	auipc	a1,0x2
ffffffffc0203d86:	4465b583          	ld	a1,1094(a1) # ffffffffc02061c8 <error_string+0x38>
ffffffffc0203d8a:	02b60633          	mul	a2,a2,a1
ffffffffc0203d8e:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203d92:	00002797          	auipc	a5,0x2
ffffffffc0203d96:	43e7b783          	ld	a5,1086(a5) # ffffffffc02061d0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203d9a:	0000d717          	auipc	a4,0xd
ffffffffc0203d9e:	78673703          	ld	a4,1926(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203da2:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203da4:	00c61793          	slli	a5,a2,0xc
ffffffffc0203da8:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203daa:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203dac:	02e7f963          	bgeu	a5,a4,ffffffffc0203dde <swapfs_read+0x80>
}
ffffffffc0203db0:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203db2:	0000d797          	auipc	a5,0xd
ffffffffc0203db6:	7867b783          	ld	a5,1926(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203dba:	46a1                	li	a3,8
ffffffffc0203dbc:	963e                	add	a2,a2,a5
ffffffffc0203dbe:	4505                	li	a0,1
}
ffffffffc0203dc0:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dc2:	edefc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203dc6:	86aa                	mv	a3,a0
ffffffffc0203dc8:	00002617          	auipc	a2,0x2
ffffffffc0203dcc:	19860613          	addi	a2,a2,408 # ffffffffc0205f60 <default_pmm_manager+0xe40>
ffffffffc0203dd0:	45d1                	li	a1,20
ffffffffc0203dd2:	00002517          	auipc	a0,0x2
ffffffffc0203dd6:	17650513          	addi	a0,a0,374 # ffffffffc0205f48 <default_pmm_manager+0xe28>
ffffffffc0203dda:	d9afc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203dde:	86b2                	mv	a3,a2
ffffffffc0203de0:	06a00593          	li	a1,106
ffffffffc0203de4:	00001617          	auipc	a2,0x1
ffffffffc0203de8:	3cc60613          	addi	a2,a2,972 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc0203dec:	00001517          	auipc	a0,0x1
ffffffffc0203df0:	38c50513          	addi	a0,a0,908 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0203df4:	d80fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203df8 <swapfs_write>:
...
ffffffffc0203e00:	c3a5                	beqz	a5,ffffffffc0203e60 <swapfs_write+0x68>
ffffffffc0203e02:	0000d717          	auipc	a4,0xd
ffffffffc0203e06:	73e73703          	ld	a4,1854(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e0a:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e60 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203e20:	3ac5b583          	ld	a1,940(a1) # ffffffffc02061c8 <error_string+0x38>
ffffffffc0203e24:	02b60633          	mul	a2,a2,a1
ffffffffc0203e28:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e2c:	00002797          	auipc	a5,0x2
ffffffffc0203e30:	3a47b783          	ld	a5,932(a5) # ffffffffc02061d0 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e46:	02e7f963          	bgeu	a5,a4,ffffffffc0203e78 <swapfs_write+0x80>
}
...
ffffffffc0203e5a:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e5c:	e68fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e60:	86aa                	mv	a3,a0
ffffffffc0203e62:	00002617          	auipc	a2,0x2
ffffffffc0203e66:	0fe60613          	addi	a2,a2,254 # ffffffffc0205f60 <default_pmm_manager+0xe40>
ffffffffc0203e6a:	45e5                	li	a1,25
ffffffffc0203e6c:	00002517          	auipc	a0,0x2
ffffffffc0203e70:	0dc50513          	addi	a0,a0,220 # ffffffffc0205f48 <default_pmm_manager+0xe28>
...
ffffffffc0203e82:	33260613          	addi	a2,a2,818 # ffffffffc02051b0 <default_pmm_manager+0x90>
ffffffffc0203e86:	00001517          	auipc	a0,0x1
ffffffffc0203e8a:	2f250513          	addi	a0,a0,754 # ffffffffc0205178 <default_pmm_manager+0x58>
ffffffffc0203e8e:	ce6fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e92 <printnum>:
 * */
static void
...
ffffffffc0203e92:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e96:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203e98:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203e9c:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203e9e:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ea2:	f022                	sd	s0,32(sp)
ffffffffc0203ea4:	ec26                	sd	s1,24(sp)
ffffffffc0203ea6:	e84a                	sd	s2,16(sp)
ffffffffc0203ea8:	f406                	sd	ra,40(sp)
ffffffffc0203eaa:	e44e                	sd	s3,8(sp)
ffffffffc0203eac:	84aa                	mv	s1,a0
ffffffffc0203eae:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203eb0:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203eb4:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203eb6:	03067e63          	bgeu	a2,a6,ffffffffc0203ef2 <printnum+0x60>
ffffffffc0203eba:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203ebc:	00805763          	blez	s0,ffffffffc0203eca <printnum+0x38>
ffffffffc0203ec0:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203ec2:	85ca                	mv	a1,s2
ffffffffc0203ec4:	854e                	mv	a0,s3
ffffffffc0203ec6:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203ec8:	fc65                	bnez	s0,ffffffffc0203ec0 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203eca:	1a02                	slli	s4,s4,0x20
ffffffffc0203ecc:	00002797          	auipc	a5,0x2
ffffffffc0203ed0:	0b478793          	addi	a5,a5,180 # ffffffffc0205f80 <default_pmm_manager+0xe60>
ffffffffc0203ed4:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203ed8:	9a3e                	add	s4,s4,a5
}
ffffffffc0203eda:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203edc:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203ee0:	70a2                	ld	ra,40(sp)
ffffffffc0203ee2:	69a2                	ld	s3,8(sp)
ffffffffc0203ee4:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ee6:	85ca                	mv	a1,s2
ffffffffc0203ee8:	87a6                	mv	a5,s1
}
ffffffffc0203eea:	6942                	ld	s2,16(sp)
ffffffffc0203eec:	64e2                	ld	s1,24(sp)
ffffffffc0203eee:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ef0:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203ef2:	03065633          	divu	a2,a2,a6
ffffffffc0203ef6:	8722                	mv	a4,s0
ffffffffc0203ef8:	f9bff0ef          	jal	ra,ffffffffc0203e92 <printnum>
ffffffffc0203efc:	b7f9                	j	ffffffffc0203eca <printnum+0x38>

ffffffffc0203efe <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203efe:	7119                	addi	sp,sp,-128
ffffffffc0203f00:	f4a6                	sd	s1,104(sp)
ffffffffc0203f02:	f0ca                	sd	s2,96(sp)
ffffffffc0203f04:	ecce                	sd	s3,88(sp)
ffffffffc0203f06:	e8d2                	sd	s4,80(sp)
ffffffffc0203f08:	e4d6                	sd	s5,72(sp)
ffffffffc0203f0a:	e0da                	sd	s6,64(sp)
ffffffffc0203f0c:	fc5e                	sd	s7,56(sp)
ffffffffc0203f0e:	f06a                	sd	s10,32(sp)
ffffffffc0203f10:	fc86                	sd	ra,120(sp)
ffffffffc0203f12:	f8a2                	sd	s0,112(sp)
ffffffffc0203f14:	f862                	sd	s8,48(sp)
ffffffffc0203f16:	f466                	sd	s9,40(sp)
ffffffffc0203f18:	ec6e                	sd	s11,24(sp)
ffffffffc0203f1a:	892a                	mv	s2,a0
ffffffffc0203f1c:	84ae                	mv	s1,a1
ffffffffc0203f1e:	8d32                	mv	s10,a2
ffffffffc0203f20:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f22:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f26:	5b7d                	li	s6,-1
ffffffffc0203f28:	00002a97          	auipc	s5,0x2
ffffffffc0203f2c:	08ca8a93          	addi	s5,s5,140 # ffffffffc0205fb4 <default_pmm_manager+0xe94>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f30:	00002b97          	auipc	s7,0x2
ffffffffc0203f34:	260b8b93          	addi	s7,s7,608 # ffffffffc0206190 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f38:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f3c:	001d0413          	addi	s0,s10,1
ffffffffc0203f40:	01350a63          	beq	a0,s3,ffffffffc0203f54 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f44:	c121                	beqz	a0,ffffffffc0203f84 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203f46:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f48:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203f4a:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f4c:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203f50:	ff351ae3          	bne	a0,s3,ffffffffc0203f44 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f54:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f58:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f5c:	4c81                	li	s9,0
ffffffffc0203f5e:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f60:	5c7d                	li	s8,-1
ffffffffc0203f62:	5dfd                	li	s11,-1
ffffffffc0203f64:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f68:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f6a:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f6e:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f72:	00140d13          	addi	s10,s0,1
ffffffffc0203f76:	04b56263          	bltu	a0,a1,ffffffffc0203fba <vprintfmt+0xbc>
ffffffffc0203f7a:	058a                	slli	a1,a1,0x2
ffffffffc0203f7c:	95d6                	add	a1,a1,s5
ffffffffc0203f7e:	4194                	lw	a3,0(a1)
ffffffffc0203f80:	96d6                	add	a3,a3,s5
ffffffffc0203f82:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203f84:	70e6                	ld	ra,120(sp)
ffffffffc0203f86:	7446                	ld	s0,112(sp)
ffffffffc0203f88:	74a6                	ld	s1,104(sp)
ffffffffc0203f8a:	7906                	ld	s2,96(sp)
ffffffffc0203f8c:	69e6                	ld	s3,88(sp)
ffffffffc0203f8e:	6a46                	ld	s4,80(sp)
ffffffffc0203f90:	6aa6                	ld	s5,72(sp)
ffffffffc0203f92:	6b06                	ld	s6,64(sp)
ffffffffc0203f94:	7be2                	ld	s7,56(sp)
ffffffffc0203f96:	7c42                	ld	s8,48(sp)
ffffffffc0203f98:	7ca2                	ld	s9,40(sp)
ffffffffc0203f9a:	7d02                	ld	s10,32(sp)
ffffffffc0203f9c:	6de2                	ld	s11,24(sp)
ffffffffc0203f9e:	6109                	addi	sp,sp,128
ffffffffc0203fa0:	8082                	ret
            padc = '0';
ffffffffc0203fa2:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203fa4:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fa8:	846a                	mv	s0,s10
ffffffffc0203faa:	00140d13          	addi	s10,s0,1
ffffffffc0203fae:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203fb2:	0ff5f593          	zext.b	a1,a1
ffffffffc0203fb6:	fcb572e3          	bgeu	a0,a1,ffffffffc0203f7a <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203fba:	85a6                	mv	a1,s1
ffffffffc0203fbc:	02500513          	li	a0,37
ffffffffc0203fc0:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203fc2:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203fc6:	8d22                	mv	s10,s0
ffffffffc0203fc8:	f73788e3          	beq	a5,s3,ffffffffc0203f38 <vprintfmt+0x3a>
ffffffffc0203fcc:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203fd0:	1d7d                	addi	s10,s10,-1
ffffffffc0203fd2:	ff379de3          	bne	a5,s3,ffffffffc0203fcc <vprintfmt+0xce>
ffffffffc0203fd6:	b78d                	j	ffffffffc0203f38 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203fd8:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203fdc:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fe0:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203fe2:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203fe6:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fea:	02d86463          	bltu	a6,a3,ffffffffc0204012 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203fee:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203ff2:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203ff6:	0186873b          	addw	a4,a3,s8
ffffffffc0203ffa:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203ffe:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204000:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204004:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204006:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc020400a:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020400e:	fed870e3          	bgeu	a6,a3,ffffffffc0203fee <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204012:	f40ddce3          	bgez	s11,ffffffffc0203f6a <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204016:	8de2                	mv	s11,s8
ffffffffc0204018:	5c7d                	li	s8,-1
ffffffffc020401a:	bf81                	j	ffffffffc0203f6a <vprintfmt+0x6c>
            if (width < 0)
ffffffffc020401c:	fffdc693          	not	a3,s11
ffffffffc0204020:	96fd                	srai	a3,a3,0x3f
ffffffffc0204022:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204026:	00144603          	lbu	a2,1(s0)
ffffffffc020402a:	2d81                	sext.w	s11,s11
ffffffffc020402c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020402e:	bf35                	j	ffffffffc0203f6a <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204030:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc020403c:	bfd9                	j	ffffffffc0204012 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc020403e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204040:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204044:	01174463          	blt	a4,a7,ffffffffc020404c <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204048:	1a088e63          	beqz	a7,ffffffffc0204204 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc020404c:	000a3603          	ld	a2,0(s4)
ffffffffc0204050:	46c1                	li	a3,16
ffffffffc0204052:	8a2e                	mv	s4,a1
...
ffffffffc020405c:	e37ff0ef          	jal	ra,ffffffffc0203e92 <printnum>
            break;
ffffffffc0204060:	bde1                	j	ffffffffc0203f38 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204062:	000a2503          	lw	a0,0(s4)
ffffffffc0204066:	85a6                	mv	a1,s1
ffffffffc0204068:	0a21                	addi	s4,s4,8
ffffffffc020406a:	9902                	jalr	s2
            break;
ffffffffc020406c:	b5f1                	j	ffffffffc0203f38 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020406e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204070:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204074:	01174463          	blt	a4,a7,ffffffffc020407c <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204078:	18088163          	beqz	a7,ffffffffc02041fa <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc020407c:	000a3603          	ld	a2,0(s4)
ffffffffc0204080:	46a9                	li	a3,10
ffffffffc0204082:	8a2e                	mv	s4,a1
ffffffffc0204084:	bfc1                	j	ffffffffc0204054 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204086:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc020408a:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020408c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020408e:	bdf1                	j	ffffffffc0203f6a <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204090:	85a6                	mv	a1,s1
ffffffffc0204092:	02500513          	li	a0,37
ffffffffc0204096:	9902                	jalr	s2
            break;
ffffffffc0204098:	b545                	j	ffffffffc0203f38 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020409a:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc020409e:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040a0:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040a2:	b5e1                	j	ffffffffc0203f6a <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc02040a4:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040a6:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040aa:	01174463          	blt	a4,a7,ffffffffc02040b2 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc02040ae:	14088163          	beqz	a7,ffffffffc02041f0 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc02040b2:	000a3603          	ld	a2,0(s4)
ffffffffc02040b6:	46a1                	li	a3,8
ffffffffc02040b8:	8a2e                	mv	s4,a1
ffffffffc02040ba:	bf69                	j	ffffffffc0204054 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc02040bc:	03000513          	li	a0,48
ffffffffc02040c0:	85a6                	mv	a1,s1
ffffffffc02040c2:	e03e                	sd	a5,0(sp)
ffffffffc02040c4:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02040c6:	85a6                	mv	a1,s1
ffffffffc02040c8:	07800513          	li	a0,120
ffffffffc02040cc:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040ce:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040d0:	6782                	ld	a5,0(sp)
ffffffffc02040d2:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040d4:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc02040d8:	bfb5                	j	ffffffffc0204054 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02040da:	000a3403          	ld	s0,0(s4)
ffffffffc02040de:	008a0713          	addi	a4,s4,8
ffffffffc02040e2:	e03a                	sd	a4,0(sp)
ffffffffc02040e4:	14040263          	beqz	s0,ffffffffc0204228 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc02040e8:	0fb05763          	blez	s11,ffffffffc02041d6 <vprintfmt+0x2d8>
ffffffffc02040ec:	02d00693          	li	a3,45
ffffffffc02040f0:	0cd79163          	bne	a5,a3,ffffffffc02041b2 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040f4:	00044783          	lbu	a5,0(s0)
ffffffffc02040f8:	0007851b          	sext.w	a0,a5
ffffffffc02040fc:	cf85                	beqz	a5,ffffffffc0204134 <vprintfmt+0x236>
ffffffffc02040fe:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204102:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204106:	000c4563          	bltz	s8,ffffffffc0204110 <vprintfmt+0x212>
ffffffffc020410a:	3c7d                	addiw	s8,s8,-1
ffffffffc020410c:	036c0263          	beq	s8,s6,ffffffffc0204130 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204110:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204112:	0e0c8e63          	beqz	s9,ffffffffc020420e <vprintfmt+0x310>
ffffffffc0204116:	3781                	addiw	a5,a5,-32
ffffffffc0204118:	0ef47b63          	bgeu	s0,a5,ffffffffc020420e <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc020411c:	03f00513          	li	a0,63
ffffffffc0204120:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204122:	000a4783          	lbu	a5,0(s4)
ffffffffc0204126:	3dfd                	addiw	s11,s11,-1
ffffffffc0204128:	0a05                	addi	s4,s4,1
ffffffffc020412a:	0007851b          	sext.w	a0,a5
ffffffffc020412e:	ffe1                	bnez	a5,ffffffffc0204106 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204130:	01b05963          	blez	s11,ffffffffc0204142 <vprintfmt+0x244>
ffffffffc0204134:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204136:	85a6                	mv	a1,s1
ffffffffc0204138:	02000513          	li	a0,32
ffffffffc020413c:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc020413e:	fe0d9be3          	bnez	s11,ffffffffc0204134 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204142:	6a02                	ld	s4,0(sp)
ffffffffc0204144:	bbd5                	j	ffffffffc0203f38 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204146:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204148:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc020414c:	01174463          	blt	a4,a7,ffffffffc0204154 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204150:	08088d63          	beqz	a7,ffffffffc02041ea <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204154:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204158:	0a044d63          	bltz	s0,ffffffffc0204212 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc020415c:	8622                	mv	a2,s0
ffffffffc020415e:	8a66                	mv	s4,s9
ffffffffc0204160:	46a9                	li	a3,10
ffffffffc0204162:	bdcd                	j	ffffffffc0204054 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204164:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204168:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc020416a:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc020416c:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204170:	8fb5                	xor	a5,a5,a3
ffffffffc0204172:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204176:	02d74163          	blt	a4,a3,ffffffffc0204198 <vprintfmt+0x29a>
ffffffffc020417a:	00369793          	slli	a5,a3,0x3
ffffffffc020417e:	97de                	add	a5,a5,s7
ffffffffc0204180:	639c                	ld	a5,0(a5)
ffffffffc0204182:	cb99                	beqz	a5,ffffffffc0204198 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204184:	86be                	mv	a3,a5
ffffffffc0204186:	00002617          	auipc	a2,0x2
ffffffffc020418a:	e2a60613          	addi	a2,a2,-470 # ffffffffc0205fb0 <default_pmm_manager+0xe90>
ffffffffc020418e:	85a6                	mv	a1,s1
ffffffffc0204190:	854a                	mv	a0,s2
ffffffffc0204192:	0ce000ef          	jal	ra,ffffffffc0204260 <printfmt>
ffffffffc0204196:	b34d                	j	ffffffffc0203f38 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204198:	00002617          	auipc	a2,0x2
ffffffffc020419c:	e0860613          	addi	a2,a2,-504 # ffffffffc0205fa0 <default_pmm_manager+0xe80>
ffffffffc02041a0:	85a6                	mv	a1,s1
ffffffffc02041a2:	854a                	mv	a0,s2
ffffffffc02041a4:	0bc000ef          	jal	ra,ffffffffc0204260 <printfmt>
ffffffffc02041a8:	bb41                	j	ffffffffc0203f38 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02041aa:	00002417          	auipc	s0,0x2
ffffffffc02041ae:	dee40413          	addi	s0,s0,-530 # ffffffffc0205f98 <default_pmm_manager+0xe78>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041b2:	85e2                	mv	a1,s8
ffffffffc02041b4:	8522                	mv	a0,s0
ffffffffc02041b6:	e43e                	sd	a5,8(sp)
ffffffffc02041b8:	196000ef          	jal	ra,ffffffffc020434e <strnlen>
ffffffffc02041bc:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02041c0:	01b05b63          	blez	s11,ffffffffc02041d6 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02041c4:	67a2                	ld	a5,8(sp)
ffffffffc02041c6:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041ca:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02041cc:	85a6                	mv	a1,s1
ffffffffc02041ce:	8552                	mv	a0,s4
ffffffffc02041d0:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041d2:	fe0d9ce3          	bnez	s11,ffffffffc02041ca <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041d6:	00044783          	lbu	a5,0(s0)
ffffffffc02041da:	00140a13          	addi	s4,s0,1
ffffffffc02041de:	0007851b          	sext.w	a0,a5
ffffffffc02041e2:	d3a5                	beqz	a5,ffffffffc0204142 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02041e4:	05e00413          	li	s0,94
ffffffffc02041e8:	bf39                	j	ffffffffc0204106 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc02041ea:	000a2403          	lw	s0,0(s4)
ffffffffc02041ee:	b7ad                	j	ffffffffc0204158 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc02041f0:	000a6603          	lwu	a2,0(s4)
ffffffffc02041f4:	46a1                	li	a3,8
ffffffffc02041f6:	8a2e                	mv	s4,a1
ffffffffc02041f8:	bdb1                	j	ffffffffc0204054 <vprintfmt+0x156>
ffffffffc02041fa:	000a6603          	lwu	a2,0(s4)
ffffffffc02041fe:	46a9                	li	a3,10
ffffffffc0204200:	8a2e                	mv	s4,a1
ffffffffc0204202:	bd89                	j	ffffffffc0204054 <vprintfmt+0x156>
ffffffffc0204204:	000a6603          	lwu	a2,0(s4)
ffffffffc0204208:	46c1                	li	a3,16
ffffffffc020420a:	8a2e                	mv	s4,a1
ffffffffc020420c:	b5a1                	j	ffffffffc0204054 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc020420e:	9902                	jalr	s2
ffffffffc0204210:	bf09                	j	ffffffffc0204122 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204212:	85a6                	mv	a1,s1
ffffffffc0204214:	02d00513          	li	a0,45
ffffffffc0204218:	e03e                	sd	a5,0(sp)
ffffffffc020421a:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc020421c:	6782                	ld	a5,0(sp)
ffffffffc020421e:	8a66                	mv	s4,s9
ffffffffc0204220:	40800633          	neg	a2,s0
ffffffffc0204224:	46a9                	li	a3,10
ffffffffc0204226:	b53d                	j	ffffffffc0204054 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204228:	03b05163          	blez	s11,ffffffffc020424a <vprintfmt+0x34c>
ffffffffc020422c:	02d00693          	li	a3,45
ffffffffc0204230:	f6d79de3          	bne	a5,a3,ffffffffc02041aa <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204234:	00002417          	auipc	s0,0x2
ffffffffc0204238:	d6440413          	addi	s0,s0,-668 # ffffffffc0205f98 <default_pmm_manager+0xe78>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020423c:	02800793          	li	a5,40
ffffffffc0204240:	02800513          	li	a0,40
ffffffffc0204244:	00140a13          	addi	s4,s0,1
ffffffffc0204248:	bd6d                	j	ffffffffc0204102 <vprintfmt+0x204>
ffffffffc020424a:	00002a17          	auipc	s4,0x2
ffffffffc020424e:	d4fa0a13          	addi	s4,s4,-689 # ffffffffc0205f99 <default_pmm_manager+0xe79>
ffffffffc0204252:	02800513          	li	a0,40
ffffffffc0204256:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020425a:	05e00413          	li	s0,94
ffffffffc020425e:	b565                	j	ffffffffc0204106 <vprintfmt+0x208>
...
ffffffffc0204274:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204276:	c89ff0ef          	jal	ra,ffffffffc0203efe <vprintfmt>
}
...
ffffffffc0204284:	e0a6                	sd	s1,64(sp)
ffffffffc0204286:	fc4a                	sd	s2,56(sp)
ffffffffc0204288:	f84e                	sd	s3,48(sp)
ffffffffc020428a:	f452                	sd	s4,40(sp)
ffffffffc020428c:	f056                	sd	s5,32(sp)
ffffffffc020428e:	ec5a                	sd	s6,24(sp)
ffffffffc0204290:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc0204292:	c901                	beqz	a0,ffffffffc02042a2 <readline+0x22>
ffffffffc0204294:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc0204296:	00002517          	auipc	a0,0x2
ffffffffc020429a:	d1a50513          	addi	a0,a0,-742 # ffffffffc0205fb0 <default_pmm_manager+0xe90>
ffffffffc020429e:	e1dfb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
ffffffffc02042a2:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc02042a4:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc02042a6:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc02042a8:	4aa9                	li	s5,10
ffffffffc02042aa:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc02042ac:	0000db97          	auipc	s7,0xd
ffffffffc02042b0:	e4cb8b93          	addi	s7,s7,-436 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042b4:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042b8:	e3bfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042bc:	00054a63          	bltz	a0,ffffffffc02042d0 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042c0:	00a95a63          	bge	s2,a0,ffffffffc02042d4 <readline+0x54>
ffffffffc02042c4:	029a5263          	bge	s4,s1,ffffffffc02042e8 <readline+0x68>
        c = getchar();
ffffffffc02042c8:	e2bfb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042cc:	fe055ae3          	bgez	a0,ffffffffc02042c0 <readline+0x40>
            return NULL;
ffffffffc02042d0:	4501                	li	a0,0
ffffffffc02042d2:	a091                	j	ffffffffc0204316 <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042d4:	03351463          	bne	a0,s3,ffffffffc02042fc <readline+0x7c>
ffffffffc02042d8:	e8a9                	bnez	s1,ffffffffc020432a <readline+0xaa>
        c = getchar();
ffffffffc02042da:	e19fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042de:	fe0549e3          	bltz	a0,ffffffffc02042d0 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042e2:	fea959e3          	bge	s2,a0,ffffffffc02042d4 <readline+0x54>
ffffffffc02042e6:	4481                	li	s1,0
            cputchar(c);
ffffffffc02042e8:	e42a                	sd	a0,8(sp)
ffffffffc02042ea:	e07fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc02042ee:	6522                	ld	a0,8(sp)
ffffffffc02042f0:	009b87b3          	add	a5,s7,s1
ffffffffc02042f4:	2485                	addiw	s1,s1,1
ffffffffc02042f6:	00a78023          	sb	a0,0(a5)
ffffffffc02042fa:	bf7d                	j	ffffffffc02042b8 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc02042fc:	01550463          	beq	a0,s5,ffffffffc0204304 <readline+0x84>
ffffffffc0204300:	fb651ce3          	bne	a0,s6,ffffffffc02042b8 <readline+0x38>
            cputchar(c);
ffffffffc0204304:	dedfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc0204308:	0000d517          	auipc	a0,0xd
ffffffffc020430c:	df050513          	addi	a0,a0,-528 # ffffffffc02110f8 <buf>
ffffffffc0204310:	94aa                	add	s1,s1,a0
ffffffffc0204312:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc0204316:	60a6                	ld	ra,72(sp)
ffffffffc0204318:	6486                	ld	s1,64(sp)
ffffffffc020431a:	7962                	ld	s2,56(sp)
ffffffffc020431c:	79c2                	ld	s3,48(sp)
ffffffffc020431e:	7a22                	ld	s4,40(sp)
ffffffffc0204320:	7a82                	ld	s5,32(sp)
ffffffffc0204322:	6b62                	ld	s6,24(sp)
ffffffffc0204324:	6bc2                	ld	s7,16(sp)
ffffffffc0204326:	6161                	addi	sp,sp,80
ffffffffc0204328:	8082                	ret
            cputchar(c);
ffffffffc020432a:	4521                	li	a0,8
ffffffffc020432c:	dc5fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204330:	34fd                	addiw	s1,s1,-1
ffffffffc0204332:	b759                	j	ffffffffc02042b8 <readline+0x38>

ffffffffc0204334 <strlen>:
...
strlen(const char *s) {
ffffffffc0204338:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc020433a:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc020433c:	cb81                	beqz	a5,ffffffffc020434c <strlen+0x18>
        cnt ++;
ffffffffc020433e:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204340:	00a707b3          	add	a5,a4,a0
ffffffffc0204344:	0007c783          	lbu	a5,0(a5)
ffffffffc0204348:	fbfd                	bnez	a5,ffffffffc020433e <strlen+0xa>
...
ffffffffc020434e:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204350:	e589                	bnez	a1,ffffffffc020435a <strnlen+0xc>
ffffffffc0204352:	a811                	j	ffffffffc0204366 <strnlen+0x18>
        cnt ++;
ffffffffc0204354:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204356:	00f58863          	beq	a1,a5,ffffffffc0204366 <strnlen+0x18>
ffffffffc020435a:	00f50733          	add	a4,a0,a5
ffffffffc020435e:	00074703          	lbu	a4,0(a4)
ffffffffc0204362:	fb6d                	bnez	a4,ffffffffc0204354 <strnlen+0x6>
ffffffffc0204364:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204366:	852e                	mv	a0,a1
ffffffffc0204368:	8082                	ret

ffffffffc020436a <strcpy>:
char *
...
ffffffffc020436a:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020436c:	0005c703          	lbu	a4,0(a1)
ffffffffc0204370:	0785                	addi	a5,a5,1
ffffffffc0204372:	0585                	addi	a1,a1,1
ffffffffc0204374:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204378:	fb75                	bnez	a4,ffffffffc020436c <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020437c:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204380:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204384:	cb89                	beqz	a5,ffffffffc0204396 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204386:	0505                	addi	a0,a0,1
ffffffffc0204388:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020438a:	fee789e3          	beq	a5,a4,ffffffffc020437c <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020438e:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204392:	9d19                	subw	a0,a0,a4
ffffffffc0204394:	8082                	ret
ffffffffc0204396:	4501                	li	a0,0
ffffffffc0204398:	bfed                	j	ffffffffc0204392 <strcmp+0x16>

ffffffffc020439a <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc020439a:	00054783          	lbu	a5,0(a0)
ffffffffc020439e:	c799                	beqz	a5,ffffffffc02043ac <strchr+0x12>
        if (*s == c) {
ffffffffc02043a0:	00f58763          	beq	a1,a5,ffffffffc02043ae <strchr+0x14>
    while (*s != '\0') {
ffffffffc02043a4:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02043a8:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02043aa:	fbfd                	bnez	a5,ffffffffc02043a0 <strchr+0x6>
    }
    return NULL;
ffffffffc02043ac:	4501                	li	a0,0
}
ffffffffc02043ae:	8082                	ret

ffffffffc02043b0 <memset>:
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02043b0:	ca01                	beqz	a2,ffffffffc02043c0 <memset+0x10>
ffffffffc02043b2:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02043b4:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02043b6:	0785                	addi	a5,a5,1
ffffffffc02043b8:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02043bc:	fec79de3          	bne	a5,a2,ffffffffc02043b6 <memset+0x6>
    }
    return s;
...
ffffffffc02043c2 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02043c2:	ca19                	beqz	a2,ffffffffc02043d8 <memcpy+0x16>
ffffffffc02043c4:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02043c6:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02043c8:	0005c703          	lbu	a4,0(a1)
ffffffffc02043cc:	0585                	addi	a1,a1,1
ffffffffc02043ce:	0785                	addi	a5,a5,1
ffffffffc02043d0:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043d4:	fec59ae3          	bne	a1,a2,ffffffffc02043c8 <memcpy+0x6>
    }
    return dst;
